                            ...
                            <table id="table-user" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="#" class="btn btn-danger btn-sm btn-block <?php echo e($user->is_admin == 0 ? 'btn-delete' : ''); ?>" data-id="<?php echo e($user->id_user); ?>" style="<?php echo e($user->is_admin == 1 ? 'cursor: not-allowed' : ''); ?>" title="<?php echo e($user->is_admin == 1 ? $user->id_user == Auth::user()->id_user ? 'Tidak dapat menghapus akun sendiri' : '' : 'Hapus'); ?>"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    <?php $i++; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views//user/admin/index.blade.php ENDPATH**/ ?>