        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    <h5 class="card-title border-bottom">Edit Blog</h5>
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/blog/update" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="judul_blog" class="form-control <?php echo e($errors->has('judul_blog') ? 'is-invalid' : ''); ?>" value="<?php echo e($blog->blog_title); ?>" placeholder="Masukkan Judul Blog">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\campusdigital\resources\views/blog/admin/edit.blade.php ENDPATH**/ ?>