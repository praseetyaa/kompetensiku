                    ...
                    <div class="card-body">
						...
						<div class="row">
							<div class="col-lg-6">
								...
								<div class="row">
									<div class="col-md-12">
										<form id="form" method="post" action="/member/e-signature/update" class="d-none">
								...
								<div class="row mt-3">
									<div class="col-md-12">
										...
										<form id="form-2" method="post" action="/member/e-signature/update" class="d-none">
											<?php echo e(csrf_field()); ?>
							...
							<div class="col-lg-6">
								<div class="row">
									<div class="col-md-12">
										...
										<img src="<?php echo e($signature != null ? asset('assets/images/signature/'.$signature->signature) : ''); ?>" class="img-thumbnail <?php echo e($signature != null ? '' : 'd-none'); ?>" style="max-height: 200px;">
									</div>
								</div>
							</div>
						</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/signature/member/index.blade.php ENDPATH**/ ?>