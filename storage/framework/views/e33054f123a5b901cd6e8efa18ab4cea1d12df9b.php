                                ...
                                <tr>
                                    <td class="content-cell">
										<table class="subcopy" width="100%" cellpadding="0" cellspacing="0" role="presentation">
											<tr id="tr-logo">
												<td align="center">
													<img id="logo" src="<?php echo e(asset('assets/images/logo/'.get_logo())); ?>" width="200">
												</td>
											</tr>
											<tr>
												<td id="td-content">
													<strong>Hai,</strong>
													<br>
													Sekedar memberitahukan bahwa <strong><?php echo e($user->nama_user); ?></strong> telah mendaftar di <?php echo e(get_website_name()); ?> dan melakukan pembayaran dengan invoice <strong><?php echo e($komisi->inv_komisi); ?></strong>.
													<br>
													<img id="komisi-proof" src="<?php echo e(asset('assets/images/komisi/'.$komisi->komisi_proof)); ?>">
													<br>
...
<?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/email/confirmation.blade.php ENDPATH**/ ?>