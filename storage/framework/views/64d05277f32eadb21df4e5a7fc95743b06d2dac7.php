				...
				<div class="">
					<div class="form-group col-md-12">
						...
						<div class="form-check form-check-inline">
							...
							<label class="form-check-label" for="checkbox-<?php echo e($i); ?>"><?php echo e((($i - 1) * 100) + 1); ?>-<?php echo e($i * 100); ?></label>
						</div>
						<?php endfor; ?>
					</div>
				</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/mail/admin/create.blade.php ENDPATH**/ ?>