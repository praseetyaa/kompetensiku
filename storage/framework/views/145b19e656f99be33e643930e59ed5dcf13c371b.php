                        ...
                        <div class="row">
                            <div class="col-12 col-sm py-1 mb-2 mb-sm-0 text-center text-sm-left">
                             ...
                             <div class="col-12 col-sm-auto text-center text-sm-left">
                                <a href="/admin/user/export?filter=<?php echo e($filter); ?>" class="btn btn-sm btn-success"><i class="fa fa-file-excel mr-2"></i> Export ke Excel</a>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group col-lg-3 col-md-6">
                            ...
                            <select id="filter" class="form-control">
                                ...
                                <option value="aktif" <?php echo e($filter == 'aktif' ? 'selected' : ''); ?>>Aktif</option>
                                <option value="belum-aktif" <?php echo e($filter == 'belum-aktif' ? 'selected' : ''); ?>>Belum Aktif</option>
                            </select>
                        </div>
                            ...
                            <table id="table-user" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo e($i); ?></td>
                                        <td>
                                            <a href="<?php echo e($user->id_user == Auth::user()->id_user ? '/admin/profil' : '/admin/user/detail/'.$user->id_user); ?>"><?php echo e($user->nama_user); ?></a>
                                            <br>
										...
										<td><span title="<?php echo e(date('Y-m-d H:i:s', strtotime($user->register_at))); ?>" style="text-decoration: underline; cursor: help;"><?php echo e(date('Y-m-d', strtotime($user->register_at))); ?></span></td>
                                        ...
                                        <td><a href="#" class="btn btn-danger btn-sm btn-block <?php echo e($user->id_user > 6 ? 'btn-delete' : ''); ?>" data-id="<?php echo e($user->id_user); ?>" style="<?php echo e($user->id_user > 6 ? '' : 'cursor: not-allowed'); ?>" title="<?php echo e($user->id_user <= 6 ? $user->id_user == Auth::user()->id_user ? 'Tidak dapat menghapus akun sendiri' : 'Akun ini tidak boleh dihapus' : 'Hapus'); ?>"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    <?php $i++; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kompetensiku.id/public_html/bisa-v2/resources/views/user/admin/index.blade.php ENDPATH**/ ?>