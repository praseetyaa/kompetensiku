...
<body>
	...
	<div id="deskripsi">Acara webinar dengan tema <span id="judul">"<?php echo e($pelatihan->nama_pelatihan); ?>"</span>. Diselenggarakan oleh Campus Digital.</div>
	<div id="text-mengetahui">Mengetahui,</div>
	<div id="text-direktur">Direktur Campus Digital</div>
	<div id="direktur">Faris Fanani</div>
	<div id="tanggal">Semarang, <?php echo e(setFullDate($pelatihan->tanggal_pelatihan)); ?></div>
	<div id="text-trainer">Trainer</div>
	<div id="trainer"><?php echo e($pelatihan->nama_user); ?></div>
	<hr id="line-1">
	<hr id="line-2">
</body>
</html><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/e-sertifikat/certificate-participant.blade.php ENDPATH**/ ?>