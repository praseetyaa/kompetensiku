<?php $__env->startSection('content'); ?>
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Tambah Paket Soal <?php echo e($tes->nama_tes); ?></h1>
  <p class="mb-4">Paket soal tes <?php echo e($tes->nama_tes); ?> yang digunakan untuk mengetes calon karyawan.</p>

  <!-- DataTales Example -->
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Tambah Paket Soal <?php echo e($tes->nama_tes); ?></h6>
    </div>
    <div class="card-body">
      <form method="post" action="/hrd/tes/tipe/<?php echo e($tes->id_tes); ?>/paket/store">
        ...
        <div class="form-group">
          ...
          <a href="/hrd/tes/tipe/<?php echo e($tes->id_tes); ?>" class="btn btn-secondary">Kembali</a>
        </div>
      </form>
    </div>
  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/hrd/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/paket-soal/hrd/create.blade.php ENDPATH**/ ?>