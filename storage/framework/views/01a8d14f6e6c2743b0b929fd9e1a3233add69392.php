        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/role/store" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Nama Role <span class="text-danger">*</span></label>
                                    <input type="text" name="nama_role" class="form-control <?php echo e($errors->has('nama_role') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('nama_role')); ?>" placeholder="Masukkan Nama Role">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/psikologanda.com/laravel-akademi/resources/views/role/admin/create.blade.php ENDPATH**/ ?>