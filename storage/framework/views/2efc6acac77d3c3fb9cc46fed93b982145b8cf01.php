			...
			<?php if(Auth::user()->status == 1): ?>
                ...
                <div class="col-lg-12">
                    <div class="card card-hover shadow">
                        <div class="card-body text-center">
                            <h4 class="card-title">Profil <?php echo e(get_website_name()); ?></h4>
                            <div class="m-t-20 m-b-20">
                                <p><?php echo nl2br($deskripsi->deskripsi); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <a class="col-lg-4 col-md-6" href="/member/<?php echo e($data->url_fitur); ?>">
                            <div class="card card-hover shadow">
...
<style type="text/css">
	...
	#popupModal .close {position: absolute; right: -15px; top: -15px; background-color: #340369; color: #fdd100; width: 25px; height: 25px; opacity: 1!important; z-index: 2;}
	.owl-nav {position: absolute; width: 100%; top: 45%;}
	.owl-carousel .owl-nav button.owl-prev {position: absolute; font-size: 30px; top: 0; left: -10px; width: 20px; background-color: #fdd100; color: #340369;}
	.owl-carousel .owl-nav button.owl-next {position: absolute; font-size: 30px; top: 0; right: -10px; width: 20px; background-color: #fdd100; color: #340369;}
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-v3/resources/views/dashboard/member/dashboard.blade.php ENDPATH**/ ?>