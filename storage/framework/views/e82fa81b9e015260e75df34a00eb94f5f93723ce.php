<?php $__env->startSection('content'); ?>
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form method="post" action="/hrd/tes/tipe/<?php echo e($id_tes); ?>/paket/tutorial/save">
        ...
        <input type="hidden" name="id_paket" value="<?php echo e(isset($tutorial) ? $tutorial->id_paket : $id_paket); ?>">
        <input type="hidden" name="id_tes" value="<?php echo e(isset($tutorial) ? $tutorial->id_tes : $id_tes); ?>">
        <button type="submit" class="btn btn-primary">Submit</button>
        <a href="/hrd/tes/tipe/<?php echo e($id_tes); ?>" class="btn btn-secondary">Kembali</a>
      </form>
    </div>
  </div>
  ...
  $(function(){
    ...
    $(document).on("click", ".delete", function(e){
      ...
      if(ask){
        $.ajax({
          type: "post",
          url: "/hrd/tes/tipe/<?php echo e($id_tes); ?>/paket/tutorial/delete",
          data: {_token: "<?php echo e(csrf_token()); ?>", id: id},
          success: function(response){
            if(response == "Berhasil menghapus data!"){
              alert(response);
              window.location.href = "/hrd/tes/tipe/<?php echo e($id_tes); ?>/paket/tutorial/<?php echo e($id_paket); ?>";
            }
          }
        })
      }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/hrd/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/tutorial/hrd/tutorial.blade.php ENDPATH**/ ?>