        ...
        <div class="row">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="card shadow">
                    <h5 class="card-title border-bottom">Tambah Testimoni</h5>
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/konten-web/testimoni/store" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Nama Klien <span class="text-danger">*</span></label>
                                    <input type="text" name="nama_klien" class="form-control <?php echo e($errors->has('nama_klien') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('nama_klien')); ?>" placeholder="Masukkan Nama Klien">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="profesi_klien" class="form-control <?php echo e($errors->has('profesi_klien') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('profesi_klien')); ?>" placeholder="Masukkan Profesi Klien">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="testimoni" class="form-control <?php echo e($errors->has('testimoni') ? 'is-invalid' : ''); ?>" rows="5" placeholder="Masukkan Testimoni"><?php echo e(old('testimoni')); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/testimoni/admin/create.blade.php ENDPATH**/ ?>