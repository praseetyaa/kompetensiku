                        ...
                        <form id="form" method="post" action="/admin/script/store" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="judul" class="form-control <?php echo e($errors->has('judul') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('judul')); ?>" placeholder="Masukkan Judul Script">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="script" class="form-control <?php echo e($errors->has('script') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Script" rows="10"><?php echo e(old('script')); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/script/admin/create.blade.php ENDPATH**/ ?>