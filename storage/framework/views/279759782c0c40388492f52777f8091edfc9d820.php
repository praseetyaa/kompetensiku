...
<head>
	...
	<style type="text/css">
		...
		@font-face {font-family: 'Old-English'; src: url(<?php echo e(asset('assets/fonts/OLDENGL.ttf')); ?>);}
		
		@page  {margin: 0px;}
		html {margin: 0px;}
		/* body {margin: 0px; font-family: 'Lato-Regular'; font-size: 18.5px; background-color: <?php echo e(get_warna_background_sertifikat()); ?>;} */
		body {margin: 0px; font-family: 'Lato-Regular'; font-size: 18.5px; background-image: url('<?php echo e(asset('assets/images/others/SERTIFIKAT BM.jpg')); ?>'); background-size: cover;}
		...
		#line-bg-2 {position: absolute; bottom: 25px; height: 5px; width: 100%; background-color: <?php echo e(get_warna_garis_2()); ?>;}
		#line-bg-1 {position: absolute; bottom: 0; height: 25px; width: 100%; background-color: <?php echo e(get_warna_garis_1()); ?>;}
	</style>
</head>
<body>
	<div id="nomor-seri">Nomor Seri: <?php echo e($member->kode_sertifikat); ?></div>
...
</html><?php /**PATH /var/www/vhosts/bisa.co.id/public_html/bisa-v2/resources/views/e-sertifikat/pdf/peserta/1.blade.php ENDPATH**/ ?>