                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
						...
						<div class="card shadow">
							...
							<div class="card-body">
								<form id="form-paket" method="post" action="/admin/another/update-paket">
						...
						<div class="card shadow">
							...
							<div class="card-body">
								<form id="form-identity" method="post" action="/admin/another/update">
									<?php echo e(csrf_field()); ?>
...
<div class="modal fade" id="modalGaleri" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="form-choose-photo" class="d-none" method="post" action="/admin/another/pilih-foto">
                <?php echo e(csrf_field()); ?>
...
<div class="modal fade" id="modalCroppie" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="form-profile-image" class="d-none" method="post" action="/admin/another/update-foto">
                <?php echo e(csrf_field()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-referral/resources/views/user/admin/another-profile.blade.php ENDPATH**/ ?>