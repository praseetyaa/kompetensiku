                            ...
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e(date('Y-m-d', strtotime($data->tanggal_pelatihan))); ?><br><?php echo e(date('H:i', strtotime($data->tanggal_pelatihan))); ?></td>
						...
						<div class="col-12">
							<div class="row">
								<?php if(count($pelatihan)>0): ?>
									...
									<a class="col-md-6 col-lg-4 col-xlg-4" href="/member/pelatihan/detail/<?php echo e($data->id_pelatihan); ?>">
										<div class="card card-hover shadow">
											<div class="box text-center">
												<div class="row text-secondary">
													<div class="col-sm-6 text-center text-sm-left"><i class="fa fa-calendar mr-2"></i><?php echo e(date('d-m-Y', strtotime($data->tanggal_pelatihan))); ?></div>
													<div class="col-sm-6 text-center text-sm-right"><i class="fa fa-clock mr-2"></i><?php echo e(date('H:i', strtotime($data->tanggal_pelatihan))); ?> WIB</div>
												</div>
												<h1 class="font-light text-primary"><i class="mdi mdi-account-star"></i></h1>
												<h4 class="text-primary mb-1"><?php echo e($data->nama_pelatihan); ?></h4>
												<div class="text-center text-dark"><?php echo e($data->nama_user); ?></div>
											</div>
										</div>
									</a>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/pelatihan/member/index.blade.php ENDPATH**/ ?>