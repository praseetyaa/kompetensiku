				...
				<div class="card-body">
					<form id="registration-form" method="post" action="/register">
					  ...
					  <div class="col-12 mb-3 text-center">
						<a href="<?php echo e(asset('assets/docs/TUTORIAL PENDAFTARAN MEMBER CAMPUS DIGITAL.pdf')); ?>" target="_blank" class="btn btn-primary"><i class="fa fa-download mr-2"></i>Download Tutorial Pendaftaran Member Campus Digital</a>
					  </div>
					  <div class="alert alert-success text-center">
						<strong>Biaya Aktivasi:</strong><br><del class="h5 text-danger">Rp. 499.000</del><br><span class="h4">Rp. <?php echo e(number_format(get_biaya_aktivasi(),0,'.','.')); ?></span>
					  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/guest/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/front/register.blade.php ENDPATH**/ ?>