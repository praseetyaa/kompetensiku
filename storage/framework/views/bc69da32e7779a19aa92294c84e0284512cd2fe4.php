     ...
     <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Tambah Karir</h4>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    <h5 class="card-title border-bottom">Tambah Karir</h5>
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/karir/store" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Judul <span class="text-danger">*</span></label>
                                    <input type="text" name="judul_karir" class="form-control <?php echo e($errors->has('judul_karir') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('judul_karir')); ?>" placeholder="Masukkan Judul Karir">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/psikologanda.com/laravel-akademi/resources/views/karir/admin/create.blade.php ENDPATH**/ ?>