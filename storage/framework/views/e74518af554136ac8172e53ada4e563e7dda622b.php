                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form id="form" method="post" action="/admin/konten-web/layanan/update" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="id" value="<?php echo e($layanan->id_layanan); ?>">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Layanan <span class="text-danger">*</span></label>
                                    <input type="text" name="layanan" class="form-control <?php echo e($errors->has('layanan') ? 'is-invalid' : ''); ?>" value="<?php echo e($layanan->layanan); ?>" placeholder="Masukkan Layanan">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="caption" class="form-control <?php echo e($errors->has('caption') ? 'is-invalid' : ''); ?>" rows="5" placeholder="Masukkan Caption"><?php echo e($layanan->layanan_caption); ?></textarea>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-sm-6 mb-2 mt-3 text-center" id="selected-icon">
                                            <div class="card card-hover shadow bg-warning">
                                                <div class="card-body">
                                                    <i class="fa-3x <?php echo e($layanan->layanan_icon); ?>"></i>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/layanan/admin/edit.blade.php ENDPATH**/ ?>