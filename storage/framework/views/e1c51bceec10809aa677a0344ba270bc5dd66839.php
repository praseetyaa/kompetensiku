...
<section class="info-section spad">
  <div class="container">
    <div class="row">
      <?php $__currentLoopData = $artikel; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		  ...
		  <div class="card bg-light shadow">
			<div class="card-body">
			  ...
			  <span class="card-link text-secondary small" title="<?php echo e(date('Y-m-d H:i:s', strtotime($blog->blog_at))); ?>" style="cursor: help;">
				<i class="fa fa-clock-o mr-2"></i> <?php echo e(generate_date($blog->blog_at)); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/guest/loans2go/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms-v2\resources\views/front/loans2go/posts.blade.php ENDPATH**/ ?>