<?php $__env->startSection('content'); ?>
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Edit HRD</h1>
  <p class="mb-4">Human Resource Department.</p>

  <!-- DataTales Example -->
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Edit HRD</h6>
    </div>
    <div class="card-body">
      <form method="post" action="/admin/hrd/update">
        <?php echo e(csrf_field()); ?>

        <div class="form-row">
          <div class="form-group col-6">
            <label>Nama:</label>
            <input name="nama" type="text" class="form-control <?php echo e($errors->has('nama') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Nama" value="<?php echo e($hrd->nama_user); ?>">
          ...
          <div class="form-group col-6">
            <label>Email:</label>
            <input name="email" type="email" class="form-control <?php echo e($errors->has('email') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Email" value="<?php echo e($hrd->email); ?>">
          ...
          <div class="form-group col-6">
            ...
            <input name="username" type="text" class="form-control <?php echo e($errors->has('username') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Username" value="<?php echo e($hrd->username); ?>">
        ...
        <div class="form-group">
          <input type="hidden" name="id" value="<?php echo e($hrd->id_user); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/hrd/admin/edit.blade.php ENDPATH**/ ?>