            ...
            <header>
                <nav class="navbar navbar-expand-lg navbar-expand-md navbar-light py-1">
                    <div class="container"> <button type="button" id="sidebarCollapse" class="navbar-toggler"> <!--span class="navbar-toggler-icon"></span--> <i data-feather="menu"></i> </button>
						<a class="navbar-brand " href="/"><img src="<?php echo e(asset('assets/images/logo/psikologi.png')); ?>" alt="Logo PersonalityTalk"></a>
			...
			</header><?php /**PATH /var/www/vhosts/psikologanda.com/laravel-akademi/resources/views/template/guest/_header.blade.php ENDPATH**/ ?>