        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/default-rekening/update">
                            <?php echo e(csrf_field()); ?>

                            <input type="hidden" name="id" value="<?php echo e($rekening->id_dr); ?>">
                            <div class="row">
                                <div class="form-group col-md-6">
									...
									<select name="platform" class="form-control <?php echo e($errors->has('platform') ? 'is-invalid' : ''); ?>">
										...
										<optgroup label="Bank">
											...
											<option value="<?php echo e($data->id_platform); ?>" <?php echo e($rekening->id_platform == $data->id_platform ? 'selected' : ''); ?>><?php echo e($data->nama_platform); ?></option>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="nomor" class="form-control number-only <?php echo e($errors->has('nomor') ? 'is-invalid' : ''); ?>" value="<?php echo e($rekening->nomor); ?>" placeholder="Masukkan Nomor">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/rekening/admin/default-edit.blade.php ENDPATH**/ ?>