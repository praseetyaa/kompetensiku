                        ...
                        <div class="row">
                            <div class="col-12 col-sm py-1 mb-2 mb-sm-0 text-center text-sm-left">
                             ...
                             <div class="col-12 col-sm-auto text-center text-sm-left">
                                <a href="/admin/email/create" class="btn btn-sm btn-primary"><i class="fa fa-pencil mr-2"></i> Tulis Pesan</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($data->nama_user); ?><br><small><?php echo e($data->email); ?></small></td>
                                        <td><span title="<?php echo e(date('Y-m-d H:i:s', strtotime($data->sent_at))); ?>" style="text-decoration: underline; cursor: help;"><?php echo e(date('Y-m-d', strtotime($data->sent_at))); ?></span></td>
                                        <td><a href="/admin/email/detail/<?php echo e($data->id_email); ?>" class="btn btn-primary btn-sm btn-block" title="View"><i class="fa fa-eye"></i></a></td>
                                    </tr>
                                    <?php $i++; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/mail/admin/index.blade.php ENDPATH**/ ?>