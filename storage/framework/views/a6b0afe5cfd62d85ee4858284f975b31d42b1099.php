    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <!-- card -->
                <div class="card shadow">
                    <h5 class="card-title border-bottom">History Penarikan</h5>
                    <div class="card-body">
                        <div class="table-responsive">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-referral/resources/views/komisi/member/index.blade.php ENDPATH**/ ?>