...
<section class="page-top-section set-bg" data-setbg="<?php echo e(asset('templates/loans2go/img/page-top-bg/2.jpg')); ?>">
  <div class="container">
    ...
    <nav class="site-breadcrumb">
      ...
      <span class="sb-item active">Blog</span>
    </nav>
  </div>
</section>
<!-- Page top Section end -->
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 my-2 bg-light shadow">
        <div class="card-body">
          <h5 class="card-title"><a href="/blog/<?php echo e($blog->blog_permalink); ?><?php echo e(Session::get('ref') != null ? '?ref='.Session::get('ref') : ''); ?>"><?php echo e($blog->blog_title); ?></a></h5>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/guest/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\campusdigital\resources\views/blog/guest/blogs.blade.php ENDPATH**/ ?>