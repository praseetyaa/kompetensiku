                        ...
                        <div class="row">
                            <div class="col-12 col-sm py-1 mb-2 mb-sm-0 text-center text-sm-left">
                             ...
                             <div class="col-12 col-sm-auto text-center text-sm-left">
                                <a href="/admin/slider/create" class="btn btn-sm btn-primary"><i class="fa fa-plus mr-2"></i> Tambah Slider</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo e($i); ?></td>
										<td><img src="<?php echo e(asset('assets/images/slider/'.$data->slider)); ?>" class="img-thumbnail" style="max-height: 150px;"></td>
                                        <td><?php echo e($data->slider_url != '' ? $data->slider_url : '-'); ?></td>
                                        <td><?php echo e($data->status_slider == 1 ? 'Tampilkan' : 'Sembunyikan'); ?></td>
                                        <td><a href="/admin/slider/edit/<?php echo e($data->id_slider); ?>" class="btn btn-warning btn-sm btn-block" title="Edit"><i class="fa fa-edit"></i></a></td>
                            ...
                            <form id="form" class="d-none" method="post" action="/admin/slider/delete">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/psikologanda.com/laravel-akademi/resources/views/slider/admin/index.blade.php ENDPATH**/ ?>