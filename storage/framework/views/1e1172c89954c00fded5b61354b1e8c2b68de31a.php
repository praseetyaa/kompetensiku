            ...
            <div class="col-lg-6">
                ...
                <div class="card shadow">
                    <div class="card-body text-justify">
                        ...
                        <div class="m-t-20 m-b-20">
                            <p class="mb-1">Aktivasi akun Anda dengan melakukan pembayaran atas paket yang Anda beli ke:</p>
                            <ol>
                                <li>BNI dengan nomor rekening 08123456 a/n PT. Campus Data Media.</li>
                                <li>OVO, Go-Pay, DANA dengan nomor 08123456789.</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="card shadow">
                    <div class="card-body text-justify">
                        ...
                        <div class="m-t-20 m-b-20">
							...
							<?php else: ?>
								<?php if($ppt->ppt_status == 0): ?>
								<p>Anda sudah membayar dan melakukan konfirmasi pembayaran. Tunggu beberapa saat sampai Admin memverifikasi konfirmasi pembayaran Anda.</p>
								<?php endif; ?>
							<?php endif; ?>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
				...
				<form id="form-confirmation" method="post" action="member/konfirmasi-pembayaran" enctype="multipart/form-data" class="d-none">
					...
					<input type="file" name="foto" id="file" name="bukti_pembayaran" accept="image/*">
				</form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-referral/resources/views/dashboard/member/dashboard.blade.php ENDPATH**/ ?>