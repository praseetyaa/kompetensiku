                        ...
                        <div class="row">
                            <div class="col-12 col-sm py-Layanan mb-2 mb-sm-0 text-center text-sm-left">
                             ...
                             <div class="col-12 col-sm-auto text-center text-sm-left">
                                <a href="/admin/konten-web/testimoni/create" class="btn btn-sm btn-primary"><i class="fa fa-plus mr-2"></i> Tambah Testimoni</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo e($i); ?></td>
										<td><?php echo e($data->klien); ?><br><small><?php echo e($data->profesi_klien); ?></small></td>
                                        <td><?php echo e($data->testimoni); ?></td>
                                        <td><a href="/admin/konten-web/testimoni/edit/<?php echo e($data->id_testimoni); ?>" class="btn btn-warning btn-sm btn-block" title="Edit"><i class="fa fa-edit"></i></a></td>
                                        <td><a href="#" class="btn btn-danger btn-sm btn-block btn-delete" data-id="<?php echo e($data->id_testimoni); ?>" title="Hapus"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    <?php $i++; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
                            <form id="form" class="d-none" method="post" action="/admin/konten-web/testimoni/delete">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/bisa.co.id/public_html/bisa-v2/resources/views/testimoni/admin/index.blade.php ENDPATH**/ ?>