                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo e($i); ?></td>
										<td><?php echo e($data->pelatihan->nama_pelatihan); ?></td>
										<td><?php echo e($data->kode_sertifikat); ?></td>
                                        <td><?php echo e(date('Y-m-d H:i', strtotime($data->pelatihan->tanggal_pelatihan))); ?></td>
										<td><a href="/member/e-sertifikat/peserta/<?php echo e($data->id_pm); ?>" class="btn btn-primary btn-sm btn-block" title="Cetak Sertifikat" target="_blank"><i class="fa fa-file-pdf"></i></a></td>
                                    </tr>
                                    <?php $i++; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/e-sertifikat/member/index.blade.php ENDPATH**/ ?>