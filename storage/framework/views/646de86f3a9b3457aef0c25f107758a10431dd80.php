        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="alert alert-warning text-center shadow">
                    Selamat datang di PersonalityTalk, <span class="font-weight-bold"><?php echo e(Auth::user()->nama_user); ?></span>!
                </div>
            </div>
            <!-- welcome text -->
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/psikologanda.com/laravel-akademi/resources/views/dashboard/member/dashboard.blade.php ENDPATH**/ ?>