<?php $__env->startSection('content'); ?>
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Edit Soal <?php echo e($tes->nama_tes); ?></h1>
  <p class="mb-4">Soal tes <?php echo e($tes->nama_tes); ?> yang digunakan untuk mengetes calon karyawan.</p>

  <!-- DataTales Example -->
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Edit Soal <?php echo e($tes->nama_tes); ?></h6>
    </div>
    <div class="card-body">
      <form method="post" action="/admin/tes/tipe/<?php echo e($id_tes); ?>/soal/update">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/soal/admin/edit.blade.php ENDPATH**/ ?>