<?php $__env->startSection('content'); ?>
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form method="post" action="/hrd/tes/tipe/<?php echo e($id_tes); ?>/soal/update">
        ...
        <div class="form-group">
          ...
          <a href="/hrd/tes/tipe/<?php echo e($id_tes); ?>/paket/soal/<?php echo e($id_paket); ?>" class="btn btn-secondary">Kembali</a>
        </div>
      </form>
    </div>
  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/hrd/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/soal/hrd/edit.blade.php ENDPATH**/ ?>