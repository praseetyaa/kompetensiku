                        ...
                        <form id="form" method="post" action="/admin/artikel/store" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="judul_artikel" class="form-control <?php echo e($errors->has('judul_artikel') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('judul_artikel')); ?>" placeholder="Masukkan Judul Artikel">
								...
								<div class="form-group col-lg-4 col-md-6">
									...
									<select name="kategori" class="form-control <?php echo e($errors->has('kategori') ? 'is-invalid' : ''); ?>" >
										...
										<option value="<?php echo e($data->id_ka); ?>" <?php echo e(old('kategori') == $data->id_ka ? 'selected' : ''); ?>><?php echo e($data->kategori); ?></option>
                                ...
                                <div class="form-group col-md-12">
                                    <label>Tag</label>
                                    <br>
                                    <input type="text" name="tag" data-role="tagsinput" class="form-control <?php echo e($errors->has('tag') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('tag')); ?>" placeholder="Masukkan Tag">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/artikel/admin/create.blade.php ENDPATH**/ ?>