    ...
    <div class="d-flex justify-content-center h-100">
      <div class="card my-auto">
        <div class="card-header text-center">
          ...
          <span data-step="3" class="<?php echo e($step == 4 ? 'active' : ''); ?>"></span>
        </div>
        <div class="card-body">
          ...
          <form method="post" action="/applicant/register/step-3" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class="form-group col-sm-6">
                ...
                <input name="nama_orang_tua" type="text" class="form-control form-control-sm <?php echo e($errors->has('nama_orang_tua') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Nama" value="<?php echo e(old('nama_orang_tua')); ?>">
              ...
              <div class="form-group col-sm-6">
                ...
                <input name="nomor_hp_orang_tua" type="text" class="form-control form-control-sm <?php echo e($errors->has('nomor_hp_orang_tua') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Nomor HP" value="<?php echo e(old('nomor_hp_orang_tua')); ?>">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-sm-6">
                ...
                <input name="pekerjaan_orang_tua" type="text" class="form-control form-control-sm <?php echo e($errors->has('pekerjaan_orang_tua') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Pekerjaan" value="<?php echo e(old('pekerjaan_orang_tua')); ?>">
...
</html><?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/auth/applicant/register-step-4.blade.php ENDPATH**/ ?>