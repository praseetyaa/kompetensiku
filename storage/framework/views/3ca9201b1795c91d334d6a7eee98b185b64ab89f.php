                    ...
                    <div class="card-title border-bottom">
                        <div class="row">
                            <div class="col-12 col-sm py-Layanan mb-2 mb-sm-0 text-center text-sm-left">
                                <h5 class="mb-0">Data Tag</h5>
                            </div>
                             <div class="col-12 col-sm-auto text-center text-sm-left">
                                <a href="/admin/artikel/tag/create" class="btn btn-sm btn-primary"><i class="fa fa-plus mr-2"></i> Tambah Tag</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo e($i); ?></td>
										<td><?php echo e($data->tag); ?></td>
										<td><?php echo e($data->slug); ?></td>
                                        <td><a href="/admin/artikel/tag/edit/<?php echo e($data->id_tag); ?>" class="btn btn-warning btn-sm btn-block" title="Edit"><i class="fa fa-edit"></i></a></td>
                                        <td><a href="#" class="btn btn-danger btn-sm btn-block btn-delete" data-id="<?php echo e($data->id_tag); ?>" title="Hapus"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    <?php $i++; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/tag/admin/index.blade.php ENDPATH**/ ?>