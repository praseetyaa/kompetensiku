                        ...
                        <form id="form" method="post" action="/admin/pelatihan/update">
                            ...
                            <div class="row">
								<div class="form-group col-md-6">
									...
									<input type="text" name="nomor_pelatihan" class="form-control <?php echo e($errors->has('nama_pelatihan') ? 'is-invalid' : ''); ?>" value="<?php echo e($pelatihan->nomor_pelatihan); ?>" readonly>
								</div>
								<div class="form-group col-md-6">
								...
								<div class="form-group col-md-6">
									...
									<input type="text" name="tempat_pelatihan" class="form-control <?php echo e($errors->has('tempat_pelatihan') ? 'is-invalid' : ''); ?>" value="<?php echo e($pelatihan->tempat_pelatihan); ?>" placeholder="Masukkan Tempat Pelatihan">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="fee_member" class="form-control number-only thousand-format <?php echo e($errors->has('fee_member') ? 'border-danger' : ''); ?>" value="<?php echo e(number_format($pelatihan->fee_member,0,'.','.')); ?>" placeholder="Masukkan Fee Member">
                                    </div>
                                    <div class="row mt-1">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="fee_umum" class="form-control number-only thousand-format <?php echo e($errors->has('fee_umum') ? 'border-danger' : ''); ?>" value="<?php echo e(number_format($pelatihan->fee_non_member,0,'.','.')); ?>" placeholder="Masukkan Fee Umum">
                                    </div>
                                    <div class="row mt-1">
                                ...
                                <div class="form-group col-md-12">
									...
									<div class="table-responsive mt-2">
										<table class="table table-bordered" id="table-materi">
											<tbody>
												<?php $__currentLoopData = $pelatihan->materi_pelatihan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$materi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<tr data-id="<?php echo e(($key+1)); ?>">
													<td><input type="text" name="kode_unit[]" class="form-control kode-unit" data-id="<?php echo e(($key+1)); ?>" value="<?php echo e($materi['kode']); ?>" placeholder="Kode Unit"></td>
													<td><input type="text" name="judul_unit[]" class="form-control judul-unit" data-id="<?php echo e(($key+1)); ?>" value="<?php echo e($materi['judul']); ?>" placeholder="Judul Unit"></td>
													<td width="150"><input type="text" name="durasi[]" class="form-control number-only durasi" value="<?php echo e($materi['durasi']); ?>" data-id="<?php echo e(($key+1)); ?>" placeholder="Durasi (Jam)"></td>
													<td width="50"><button class="btn btn-danger btn-block btn-delete <?php echo e(count($pelatihan->materi_pelatihan) <= 1 ? 'd-none' : ''); ?>" data-id="<?php echo e(($key+1)); ?>" title="Hapus"><i class="fa fa-trash"></i></button></td>
												</tr>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</tbody>
										</table>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("input[name=tanggal_pelatihan]").daterangepicker({
    		...
    		showDropdowns: true,
			startDate: "<?php echo e(generate_date_range('join', $pelatihan->tanggal_pelatihan_from.' - '.$pelatihan->tanggal_pelatihan_to)['from']); ?>",
			endDate: "<?php echo e(generate_date_range('join', $pelatihan->tanggal_pelatihan_from.' - '.$pelatihan->tanggal_pelatihan_to)['to']); ?>",
			locale: {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/pelatihan/admin/edit.blade.php ENDPATH**/ ?>