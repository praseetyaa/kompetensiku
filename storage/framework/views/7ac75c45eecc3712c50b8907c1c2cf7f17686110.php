										...
										<table class="subcopy" width="100%" cellpadding="0" cellspacing="0" role="presentation">
											...
											<tr>
												<td id="td-content">
													...
													<br>
													Selamat Datang di <?php echo e(get_website_name()); ?>!
													<br>
													Akun Anda telah berhasil diverifikasi. Sekarang Anda sudah dapat menggunakan fasilitas dari kami. Caranya tinggal <strong><a href="<?php echo e(URL::to('/')); ?>"  target="_blank">KLIK DISINI</a></strong>.
												</td>
											</tr>
										</table>
                                    </td>
...
<?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/email/verification.blade.php ENDPATH**/ ?>