                ...
                <div class="card shadow">
                    <div class="card-body text-justify">
                        ...
                        <div class="m-t-20 m-b-20">
                            ...
                            <p>Jika orang yang diajak mendaftar melalui URL referral, maka kita biasanya kita akan mendapatkan komisi. Disini, kami memberikan komisi berupa uang sebesar <strong class="text-danger">Rp. <?php echo e(Auth::user()->role == role_trainer() ? number_format(get_special_comission(),0,',','.') : number_format(get_comission(),0,',','.')); ?></strong> setiap ada member baru yang bergabung melalui URL referral.</p>
...
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/afiliasi/member/cara-jualan.blade.php ENDPATH**/ ?>