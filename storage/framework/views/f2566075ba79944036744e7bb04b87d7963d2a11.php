                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/e-course/store" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="chapter" value="<?php echo e($chapter->id_cc); ?>">
                            <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/e-course/admin/create.blade.php ENDPATH**/ ?>