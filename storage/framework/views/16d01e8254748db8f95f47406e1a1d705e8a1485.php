						...
						<div class="col-12">
							...
							<div class="row" id="data-file">
								<?php if(count($folders)>0 || count($files)>0): ?>
									...
									<a class="col-md-6 col-lg-4 col-xlg-4" href="/member/e-competence/view/<?php echo e($file->id_file); ?>" target="_blank">
										<div class="card card-hover shadow">
											<div class="box text-center">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/e-competence/member/index.blade.php ENDPATH**/ ?>