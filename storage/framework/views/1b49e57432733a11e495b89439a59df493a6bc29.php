                        ...
                        <form id="form" method="post" action="/admin/konten-web/fitur/store" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="nama_fitur" class="form-control <?php echo e($errors->has('nama_fitur') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('nama_fitur')); ?>" placeholder="Masukkan Nama Fitur">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="keterangan_fitur" class="form-control <?php echo e($errors->has('keterangan_fitur') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Keterangan Fitur"><?php echo e(old('keterangan_fitur')); ?></textarea>
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="url_fitur" class="form-control <?php echo e($errors->has('url_fitur') ? 'border-danger' : ''); ?>" value="<?php echo e(old('url_fitur')); ?>" placeholder="Masukkan URL">
                                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/fitur/admin/create.blade.php ENDPATH**/ ?>