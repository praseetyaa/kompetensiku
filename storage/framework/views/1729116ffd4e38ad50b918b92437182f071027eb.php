	...
	<header class="header-section">
		<a href="/<?php echo e(Session::get('ref') != null ? '?ref='.Session::get('ref') : ''); ?>" class="site-logo">
			<img src="<?php echo e(asset('assets/images/logo/logo-white.png')); ?>" height="75" alt="">
		</a>
		<nav class="header-nav">
			...
			<div class="header-right">
				...
				<a href="/register<?php echo e(Session::get('ref') != null ? '?ref='.Session::get('ref') : ''); ?>" class="hr-btn hr-btn-2">Register</a>
			</div>
		</nav>
	</header>
	<!-- Header Section end --><?php /**PATH D:\XAMPP\htdocs\pra-kerja\resources\views/template/guest/_header.blade.php ENDPATH**/ ?>