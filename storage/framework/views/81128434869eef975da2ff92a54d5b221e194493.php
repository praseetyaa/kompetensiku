...
<script type="text/javascript">	
	...
	$(document).on("change", ".checkbox-batch", function(){
		...
		if(count > 1){
			...
			if(value == 1){
				var checkeds = $(".input-receivers").slice(0,20);
				checkeds.each(function(){
					check == true ? $(this).attr("checked","checked") : $(this).removeAttr("checked");
				});
			}
			else if(value == 2){
				var checkeds = $(".input-receivers").slice(20,40);
				checkeds.each(function(){
					check == true ? $(this).attr("checked","checked") : $(this).removeAttr("checked");
				});
			}
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/mail/admin/create.blade.php ENDPATH**/ ?>