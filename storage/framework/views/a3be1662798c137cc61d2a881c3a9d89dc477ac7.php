                        ...
                        <form id="form" method="post" action="/member/rekening/store">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="bank" class="form-control <?php echo e($errors->has('bank') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('bank')); ?>" placeholder="Masukkan Nama Bank">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="nomor_rekening" class="form-control number-only <?php echo e($errors->has('nomor_rekening') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('nomor_rekening')); ?>" placeholder="Masukkan Nomor Rekening">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="atas_nama" class="form-control <?php echo e($errors->has('atas_nama') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('atas_nama')); ?>" placeholder="Masukkan Nama Pemilik Rekening">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\pra-kerja\resources\views/rekening/member/create.blade.php ENDPATH**/ ?>