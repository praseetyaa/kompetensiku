                        ...
                        <form id="form" method="post" action="/admin/konten-web/deskripsi/update" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <textarea name="deskripsi" class="form-control" rows="10"><?php echo $deskripsi->deskripsi; ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-v3/resources/views/deskripsi/admin/index.blade.php ENDPATH**/ ?>