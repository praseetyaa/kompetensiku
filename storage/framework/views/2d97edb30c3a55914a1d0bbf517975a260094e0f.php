	...
	<div>
		<div class="title">
			<div class="container">
				<div class="row">
					<div>
						<h1 class="col-12 px-md-0">Registrasi</h1>
				...
				<div class="card-body">
					<form id="registration-form" method="post" action="/register">
					  ...
					  <div class="alert alert-success text-center m-0 mb-3">
						...
						<del>Rp. 499.000</del><br>
						<h5>Rp. <?php echo e(number_format(biayaAktivasi(),0,'.','.')); ?></h5>
					  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/guest/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/psikologanda.com/laravel-akademi/resources/views/front/register.blade.php ENDPATH**/ ?>