                            ...
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo e($i); ?></td>
										<td>
                                            <a href="/member/user/detail/<?php echo e($data->id_user); ?>"><?php echo e($data->nama_user); ?></a>
                                            <br>
                                            <small><?php echo e($data->kode_trainer); ?></small>
                                        </td>
										<td>
										...
										<td>
											...
											<div class="dropdown-menu dropdown-menu-right shadow">
											  <a class="dropdown-item" href="/member/e-sertifikat/trainer/detail/<?php echo e($data->id_pelatihan); ?>?page=1" target="_blank">Halaman Depan</a>
											  <!--<a class="dropdown-item" href="/admin/e-sertifikat/trainer/detail/<?php echo e($data->id_pelatihan); ?>?page=2" target="_blank">Halaman Belakang</a>-->
											</div>
										</td>
                                    </tr>
                                    <?php $i++; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/e-sertifikat/member/index-trainer.blade.php ENDPATH**/ ?>