            ...
            <div class="auth-box border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><a href="/<?php echo e(Session::get('ref') != null ? '?ref='.Session::get('ref') : ''); ?>"><img src="<?php echo e(asset('assets/images/logo/5.png')); ?>" height="100" alt="logo" /></a></span>
                    </div>
                    <!-- Form -->
...
</html><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/auth/login.blade.php ENDPATH**/ ?>