  ...
  <div class="modal fade" id="TimeTestModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form method="post" action="/admin/tahap-administrasi/is-pass">
          <?php echo e(csrf_field()); ?>
...
<script type="text/javascript">
  ...
  $(document).on("click", "#lolos", function(e){
    e.preventDefault();
    var ask = confirm("Anda yakin ingin meloloskan pelamar ini dari tes administrasi?");
    if(ask){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\recruitment\resources\views/pelamar/admin/profile-1.blade.php ENDPATH**/ ?>