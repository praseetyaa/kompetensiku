...
<body background="<?php echo e(asset('assets/images/background/hrd.jpg')); ?>">
    ...
    <div class="d-flex justify-content-center h-100">
      <div class="card my-auto">
        <div class="card-body">
          ...
          <?php endif; ?>
          <form class="user" method="post" action="/hrd/login">
...
<?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/auth/hrd/login.blade.php ENDPATH**/ ?>