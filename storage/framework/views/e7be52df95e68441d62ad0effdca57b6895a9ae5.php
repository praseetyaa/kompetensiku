                    ...
                    <div class="col-md-6 mx-md-auto">
                        <div class="card shadow">
                            ...
                            <div class="border-top">
                                <a href="/admin/e-book?dir=<?php echo e($directory->dir_folder); ?>" class="btn btn-block btn-warning">Kembali ke Data Produk</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $(document).on("click", "#btn-upload", function(e){
        ...
        var id_folder = document.getElementById("id_folder").value;
        var jenis_file = document.getElementById("jenis_file").value;
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/download/admin/upload.blade.php ENDPATH**/ ?>