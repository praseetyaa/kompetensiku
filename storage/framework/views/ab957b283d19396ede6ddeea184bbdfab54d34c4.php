                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/admin/program">Program</a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    <h5 class="card-title border-bottom">Edit Program</h5>
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form id="form" method="post" action="/admin/program/update" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

							<input type="hidden" name="id" value="<?php echo e($program->id_program); ?>">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Judul <span class="text-danger">*</span></label>
                                    <input type="text" name="judul_program" class="form-control <?php echo e($errors->has('judul_program') ? 'is-invalid' : ''); ?>" value="<?php echo e($program->program_title); ?>" placeholder="Masukkan Judul Program">
                                    <?php if($errors->has('judul_program')): ?>
                                    <small class="text-danger"><?php echo e(ucfirst($errors->first('judul_program'))); ?></small>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group col-md-12">
                                    <label>Kategori <span class="text-danger">*</span></label>
									<select name="kategori" class="form-control col-md-4  <?php echo e($errors->has('kategori') ? 'is-invalid' : ''); ?>">
										<option value="" disabled selected>--Pilih--</option>
										<option value="1" <?php echo e($program->program_kategori == 1 ? 'selected' : ''); ?>>Online Class</option>
										<option value="2" <?php echo e($program->program_kategori == 2 ? 'selected' : ''); ?>>Online Course</option>
										<option value="3" <?php echo e($program->program_kategori == 3 ? 'selected' : ''); ?>>Workshop</option>
										<option value="4" <?php echo e($program->program_kategori == 4 ? 'selected' : ''); ?>>Sertifikasi</option>
									</select>
                                ...
                                <div class="form-group col-md-12">
									...
									<br>
									<img id="img-file" src="<?php echo e($program->program_gambar != '' ? asset('assets/images/cover-program/'.$program->program_gambar) : ''); ?>" class="mt-2 img-thumbnail <?php echo e($program->program_gambar != '' ? '' : 'd-none'); ?>" style="max-height: 150px">
									<input type="hidden" name="gambar" id="src-img">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>Konten <span class="text-danger">*</span></label>
                                    <textarea name="konten" id="konten" class="d-none"></textarea>
                                    <div id="editor"><?php echo html_entity_decode($program->konten); ?></div> 
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/psikologanda.com/laravel-akademi/resources/views/program/admin/edit.blade.php ENDPATH**/ ?>