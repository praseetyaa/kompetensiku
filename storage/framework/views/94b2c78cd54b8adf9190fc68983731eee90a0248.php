...
<head>
    <title>E...Tiket | Login Page</title>
            ...
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20">
                        <span class="db"><img src="<?php echo e(asset('templates/matrix-admin/assets/images/logo.png')); ?>" alt="logo" /></span>
                    </div>
                    <!-- Form -->
                        ...
                        <div class="row p-b-30">
                            <div class="col-12">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="username" class="form-control form-control-lg <?php echo e($errors->has('username') ? 'border-danger' : ''); ?>" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
...
</html><?php /**PATH D:\XAMPP\htdocs\e-tiket\resources\views/auth/login.blade.php ENDPATH**/ ?>