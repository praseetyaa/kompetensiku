                    ...
                    <div class="card-title border-bottom">
                        <div class="row">
                            <div class="col-12 col-sm py-1 mb-2 mb-sm-0 text-center text-sm-left">
                                <h5 class="mb-0">Materi E-Book</h5>
                            </div>
                    ...
                    <div class="card-body">
						<div class="col-12 mb-4">
							...
							<?php elseif($directory->folder_parent == 1): ?>
								<strong>Folder:</strong><br><a href="/member/e-book?dir=/">Home</a> &raquo; <?php echo e($directory->nama_folder); ?>
						...
						<div class="col-12">
							<div class="row" id="data-folder">
								...
								<a class="col-md-6 col-lg-4 col-xlg-4" href="/member/e-book?dir=<?php echo e($folder->dir_folder); ?>">
							...
							<div class="row" id="data-file">
								<?php if(count($folders)>0 || count($files)>0): ?>
									...
									<a class="col-md-6 col-lg-4 col-xlg-4" href="/member/e-book/view/<?php echo e($file->id_file); ?>">
										<div class="card card-hover shadow">
											<div class="box text-center">
		...
		//if(search != ''){
			$.ajax({
				...
				success: function(response){
					...
					html3 += '<div class="alert alert-danger text-center">Materi E-Book belum tersedia.</div>';
					html3 += '</div>';
					$(result.folders).each(function(key,data){
						html += '<a class="col-md-6 col-lg-4 col-xlg-4" href="/member/e-book?dir='+data.dir_folder+'">';
					...
					$(result.files).each(function(key,data){
						html2 += '<a class="col-md-6 col-lg-4 col-xlg-4" href="/member/e-book/view/'+data.id_file+'" target="_blank">';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/psikologanda.com/laravel-akademi/resources/views/e-book/member/index.blade.php ENDPATH**/ ?>