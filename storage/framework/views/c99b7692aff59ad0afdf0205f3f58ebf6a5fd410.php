                    ...
                    <div class="col-lg-6">
                        <div class="card card-hover bg-cyan shadow">
                            <div class="card-body text-center">
                                <h4>URL Referral</h4>
                                <p class="mb-0 h4"><a class="text-light font-weight-bold" href="<?php echo e(URL::to('/')); ?>?ref=<?php echo e($user->username); ?>" target="_blank"><?php echo e(URL::to('/')); ?>?ref=<?php echo e($user->username); ?></a></p>
                            </div>
                        </div>
                    </div>
                    <!-- column -->
                    ...
                    <div class="col-lg-6">
                        <div class="card card-hover bg-warning shadow">
                            <div class="card-body text-center">
                                ...
                                <p class="mb-0 h4 font-weight-bold <?php echo e($user->saldo >= get_min_withdrawal() ? 'text-primary' : 'text-danger'); ?>">Rp. <?php echo e(number_format($user->saldo,0,',','.')); ?></p>
                            </div>
                        </div>
                    </div>
                    <!-- column -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-auto mx-auto p-0">
                                        <img src="<?php echo e($user->foto != '' ? asset('assets/images/users/'.$user->foto) : asset('assets/images/default/user.jpg')); ?>" class="img-thumbnail img-fluid" id="image" height="200" width="200">
								...
								<form id="form-identity" method="post" action="#">
									...
									<div class="row">
                                        ...
                                        <div class="form-group col-md-12">
                                            ...
                                            <div><?php echo e(generate_date(date('Y-m-j', strtotime($user->tanggal_lahir)))); ?></div>
                                        </div>
                                        <div class="form-group col-md-12">
                        ...
                        <div class="card shadow">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label>Refer:</label>
                                        <div><?php echo e(count($refer)); ?> orang <strong class="text-primary">(<?php echo e(count($refer_aktif)); ?> aktif)</strong></div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label>Login Terakhir:</label>
                                        <div>
											<?php if($user->last_visit != null): ?>
												<?php echo e(generate_date(date('Y-m-j', strtotime($user->last_visit)))); ?> pukul <?php echo e(date('H:i:s', strtotime($user->last_visit))); ?>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div><?php echo e(generate_date(date('Y-m-j', strtotime($user->register_at)))); ?> pukul <?php echo e(date('H:i:s', strtotime($user->register_at))); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/user/admin/detail-member.blade.php ENDPATH**/ ?>