                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div><?php echo e(setFullDate(date('Y-m-j', strtotime(Auth::user()->last_visit)))); ?> pukul <?php echo e(date('H:i:s', strtotime(Auth::user()->last_visit))); ?></div>
                                    </div>
                                    <div class="form-group col-md-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/user/member/profile.blade.php ENDPATH**/ ?>