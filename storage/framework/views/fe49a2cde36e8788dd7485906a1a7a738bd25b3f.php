            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item <?php echo e(strpos(Request::url(), '/e-book') ? 'selected' : ''); ?>"> <a class="sidebar-link waves-effect waves-dark sidebar-link <?php echo e(strpos(Request::url(), '/e-e-book') ? 'active' : ''); ?>" href="/member/e-book" aria-expanded="false"><i class="mdi mdi-book-multiple"></i><span class="hide-menu">Materi E-Book</span></a></li>
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/member/pelatihan" aria-expanded="false"><i class="mdi mdi-school"></i><span class="hide-menu">Pelatihan</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/member/e-sertifikat" aria-expanded="false"><i class="mdi mdi-certificate"></i><span class="hide-menu">E-Sertifikat</span></a></li>
						<?php endif; ?>
        ...
        <!-- ============================================================== --><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/template/member/_sidebar.blade.php ENDPATH**/ ?>