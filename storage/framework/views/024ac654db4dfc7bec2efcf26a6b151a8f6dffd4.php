...
<body>
	...
	<div id="tanggal">Semarang, <?php echo e(generate_date($pelatihan->tanggal_pelatihan)); ?></div>
	<div id="text-trainer">Trainer</div>
	<div id="trainer"><?php echo e($pelatihan->nama_user); ?></div>
	<hr id="line-1">
	<hr id="line-2">
</body>
</html><?php /**PATH C:\xampp\htdocs\lms\resources\views/e-sertifikat/certificate-participant.blade.php ENDPATH**/ ?>