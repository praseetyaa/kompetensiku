<?php $__env->startSection('content'); ?>
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form method="post" action="/hrd/lowongan/store">
        ...
        <a href="/hrd/lowongan" class="btn btn-secondary">Kembali</a>
      </form>
    </div>
  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/hrd/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/lowongan/hrd/create.blade.php ENDPATH**/ ?>