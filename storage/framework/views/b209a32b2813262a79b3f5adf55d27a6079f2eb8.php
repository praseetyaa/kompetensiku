                                ...
                                <tr>
                                    <td class="content-cell">
										<table class="subcopy" width="100%" cellpadding="0" cellspacing="0" role="presentation">
											<tr id="tr-logo">
												<td align="center">
													<img id="logo" src="<?php echo e(asset('assets/images/logo/logo.jpg')); ?>" width="200">
												</td>
											</tr>
											<tr id="tr-content">
												<td>
													<span id="receiver">Dear <strong><?php echo e($receiver->nama_user); ?>,</strong></span>
													<br><br>
...
<?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/email/message.blade.php ENDPATH**/ ?>