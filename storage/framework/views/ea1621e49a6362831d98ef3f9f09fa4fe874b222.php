                        ...
                        <form id="form" method="post" action="/admin/pengaturan/update">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    <label><?php echo e($settings[$key]->setting_name); ?> <span class="text-danger">*</span></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/pengaturan/admin/index.blade.php ENDPATH**/ ?>