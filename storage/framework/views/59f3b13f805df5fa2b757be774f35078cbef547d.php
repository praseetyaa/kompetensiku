                                    ...
                                    <tr>
										...
										<td>
											...
											<div class="dropdown-menu dropdown-menu-right shadow">
											  <a class="dropdown-item" href="/admin/e-sertifikat/peserta/detail/<?php echo e($data->id_pm); ?>?page=1" target="_blank">Halaman Depan</a>
											  <a class="dropdown-item" href="/admin/e-sertifikat/peserta/detail/<?php echo e($data->id_pm); ?>?page=2" target="_blank">Halaman Belakang</a>
											</div>
										</td>
                                    </tr>
                                    <?php $i++; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/bisa.co.id/public_html/bisa-v2/resources/views/e-sertifikat/admin/index-participant.blade.php ENDPATH**/ ?>