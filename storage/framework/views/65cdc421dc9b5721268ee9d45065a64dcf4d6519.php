    ...
    <footer class="page-footer font-small pt-2">
        <div class="container text-center text-md-left">
                    ...
                    <div class="d-flex">
                        <div>
                            <ul class="list-unstyled">
                                <li><a href="#">Tentang PersonalityTalk</a></li>
                    ...
                    <div class="d-flex">
                        ...
                        <div>
                            <ul class="list-unstyled">
                                ...
                                <li><a href="/benefit">Yang Kamu Dapat</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <div class="footer-copyright">PersonalityTalk © 2020. All rights reserved.</div>
        </div>
    </footer><?php /**PATH /var/www/vhosts/psikologanda.com/laravel-akademi/resources/views/template/guest/_footer.blade.php ENDPATH**/ ?>