                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="chapter_nomor" class="form-control <?php echo e($errors->has('chapter_nomor') ? 'is-invalid' : ''); ?>">
                                        ...
                                        <?php for($i=0; $i<=100; $i++): ?>
										<option value="<?php echo e($i); ?>" <?php echo e(in_array($i, $array) ? 'disabled' : ''); ?>>Chapter #<?php echo e($i); ?></option>
                                        <?php endfor; ?>
									</select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/e-course/admin/create-chapter.blade.php ENDPATH**/ ?>