                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form id="form" method="post" action="/admin/artikel/tag/update" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="id" value="<?php echo e($tag->id_tag); ?>">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Tag <span class="text-danger">*</span></label>
                                    <input type="text" name="tag" class="form-control <?php echo e($errors->has('tag') ? 'is-invalid' : ''); ?>" value="<?php echo e($tag->tag); ?>" placeholder="Masukkan Tag">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/tag/admin/edit.blade.php ENDPATH**/ ?>