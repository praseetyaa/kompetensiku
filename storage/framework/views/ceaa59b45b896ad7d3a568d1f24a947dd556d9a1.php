                    ...
                    <div class="col-lg-6">
                        <div class="card card-hover bg-cyan shadow">
                            <div class="card-body text-center">
                                <h4>URL Referral</h4>
                                <p class="mb-0 h5"><a class="text-light font-weight-bold" href="<?php echo e(URL::to('/')); ?>?ref=<?php echo e($user->username); ?>" target="_blank"><?php echo e(URL::to('/')); ?>?ref=<?php echo e($user->username); ?></a></p>
                            </div>
                        </div>
                    </div>
                    <!-- column -->
                    ...
                    <div class="col-lg-6">
                        <div class="card card-hover bg-warning shadow">
                            <div class="card-body text-center">
                                ...
                                <p class="mb-0 h3 font-weight-bold <?php echo e($user->saldo >= minWithdrawal() ? 'text-primary' : 'text-danger'); ?>">Rp. <?php echo e(number_format($user->saldo,0,',','.')); ?></p>
                            </div>
                        </div>
                    </div>
                    <!-- column -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div><?php echo e(setFullDate(date('Y-m-j', strtotime($user->last_visit)))); ?> pukul <?php echo e(date('H:i:s', strtotime($user->last_visit))); ?></div>
                                    </div>
                                    <div class="form-group col-md-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/user/admin/detail-member.blade.php ENDPATH**/ ?>