	...
	<meta name="title" content="<?php echo e(get_website_name()); ?>"/>
	<meta name="description" content="<?php echo e(get_website_name()); ?>"/>
	<meta name="keywords" content="<?php echo e(get_website_name()); ?>"/>
	<meta name="author" content="<?php echo e(get_website_name()); ?>"/>
	<meta itemProp="name" content="<?php echo e(get_website_name()); ?>"/>
	<meta itemprop="url" content="<?php echo e(URL::to('/')); ?>" />
	<meta itemProp="description" content="<?php echo e(get_website_name()); ?>"/>
	<meta itemProp="image" content="<?php echo e(asset('assets/images/logo/'.get_icon())); ?>"/>
	<meta property="og:site_name" content="<?php echo e(get_website_name()); ?>" />
	<meta property="og:title" content="<?php echo e(get_website_name()); ?>" />
	<meta property="og:description" content="<?php echo e(get_website_name()); ?>"/>
	<meta property="og:type" content="website" />
	<meta property="og:image" content="<?php echo e(asset('assets/images/logo/'.get_icon())); ?>" />
	<meta property="og:url" content="<?php echo e(URL::to('/')); ?>" />
	<meta name="twitter:card" content="photo" />
	<meta name="twitter:title" content="<?php echo e(get_website_name()); ?>" />
	<meta name="twitter:description" content="<?php echo e(get_website_name()); ?>" />
	<meta name="twitter:image" content="<?php echo e(asset('assets/images/logo/'.get_icon())); ?>" />
	<meta name="twitter:domain" content="qubisa.com"/>
	<link rel="canonical" href="<?php echo e(URL::to('/')); ?>"/>
	<link rel="image_src" href="<?php echo e(asset('assets/images/logo/'.get_icon())); ?>"/>
	<link rel="shortcut icon" href="<?php echo e(asset('assets/images/logo/'.get_icon())); ?>" type="image/x-icon">
	...
	</style><?php /**PATH C:\xampp\htdocs\lms-v2\resources\views/template/guest/qubisa/_head.blade.php ENDPATH**/ ?>