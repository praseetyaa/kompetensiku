     ...
     <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Materi E-Library</h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/member">Home</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Materi E-Library</li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-body">
						<div class="col-12 mb-4">
							...
							<?php elseif($directory->folder_parent == 1): ?>
								<strong>Folder:</strong><br><a href="/member/e-library?dir=/">Home</a> &raquo; <?php echo e($directory->nama_folder); ?>
						...
						<div class="col-12">
							<div class="row" id="data-folder">
								...
								<a class="col-md-6 col-lg-4 col-xlg-4" href="/member/e-library?dir=<?php echo e($folder->dir_folder); ?>">
							...
							<div class="row" id="data-file">
								<?php if(count($folders)>0 || count($files)>0): ?>
									...
									<a class="col-md-6 col-lg-4 col-xlg-4" href="/member/e-library/view/<?php echo e($file->id_file); ?>">
										<div class="card card-hover shadow">
											<div class="box text-center">
								...
								<?php else: ?>
								<div class="col-12">
									<div class="alert alert-danger text-center">Materi E-Library belum tersedia.</div>
								</div>
								<?php endif; ?>
							</div>
						</div>
		...
		//if(search != ''){
			$.ajax({
				...
				success: function(response){
					...
					html3 += '<div class="alert alert-danger text-center">Materi E-Library belum tersedia.</div>';
					html3 += '</div>';
					$(result.folders).each(function(key,data){
						html += '<a class="col-md-6 col-lg-4 col-xlg-4" href="/member/e-library?dir='+data.dir_folder+'">';
					...
					$(result.files).each(function(key,data){
						html2 += '<a class="col-md-6 col-lg-4 col-xlg-4" href="/member/e-library/view/'+data.id_file+'" target="_blank">';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/psikologanda.com/laravel-akademi/resources/views/e-library/member/index.blade.php ENDPATH**/ ?>