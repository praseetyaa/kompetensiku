                        ...
                        <div class="row">
                            <div class="col-12 col-sm py-1 mb-2 mb-sm-0 text-center text-sm-left">
                             ...
                             <div class="col-12 col-sm-auto text-center text-sm-left">
                                <a href="/admin/blog/create" class="btn btn-sm btn-primary"><i class="fa fa-plus mr-2"></i> Tambah Artikel</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo e($i); ?></td>
                                        <td><?php echo e($data->blog_title); ?></td>
                                        <td><?php echo e($data->nama_user); ?></td>
                                        <td><span title="<?php echo e(date('Y-m-d H:i:s', strtotime($data->blog_at))); ?>" style="text-decoration: underline; cursor: help;"><?php echo e(date('Y-m-d', strtotime($data->blog_at))); ?></span></td>
                                        <td><a href="/artikel/<?php echo e($data->blog_permalink); ?>" class="btn btn-primary btn-sm btn-block" title="View" target="_blank"><i class="fa fa-eye"></i></a></td>
                                        <td><a href="/admin/blog/edit/<?php echo e($data->id_blog); ?>" class="btn btn-warning btn-sm btn-block" title="Edit"><i class="fa fa-edit"></i></a></td>
                                        <td><a href="#" class="btn btn-danger btn-sm btn-block btn-delete" data-id="<?php echo e($data->id_blog); ?>" title="Hapus"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    <?php $i++; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
                            <form id="form" class="d-none" method="post" action="/admin/blog/delete">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/blog/admin/index.blade.php ENDPATH**/ ?>