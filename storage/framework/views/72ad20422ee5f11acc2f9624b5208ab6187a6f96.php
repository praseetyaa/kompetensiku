                            ...
                            <table id="table-arsip-komisi" class="table table-striped table-bordered">
                                <thead>
                                    <tr>
                                        ...
                                        <th width="75">Paket</th>
                                        <th width="50">Refer</th>
                                        <th width="80">Komisi (Rp.)</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo e($i); ?></td>
                                        <td><a href="/admin/member/profil/<?php echo e($user->id_user); ?>"><?php echo e($user->nama_user); ?></a></td>
                                        <td><?php echo e($user->username); ?></td>
                                        <td><?php echo e($user->email); ?></td>
                                        <td><?php echo e($user->nama_paket); ?></td>
                                        <td><?php echo e(number_format($user->refer,0,',','.')); ?></td>
                                        <td><?php echo e(number_format($user->komisi,0,',','.')); ?></td>
                                        <td><a href="#" class="btn btn-danger btn-sm btn-block" data-id="<?php echo e($user->id_user); ?>" style="cursor: not-allowed;" title="Hapus"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    <?php $i++; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </tbody>
                            </table>
                            <form id="form" class="d-none" method="post" action="/admin/member/delete">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-referral/resources/views//user/admin/member.blade.php ENDPATH**/ ?>