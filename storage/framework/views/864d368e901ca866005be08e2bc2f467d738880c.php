                        ...
                        <div class="row">
                            <div class="col-12 col-sm py-1 mb-2 mb-sm-0 text-center text-sm-left">
                             ...
                             <div class="col-12 col-sm-auto text-center text-sm-left">
                                <a href="/admin/create" class="btn btn-sm btn-primary"><i class="fa fa-plus mr-2"></i> Tambah Admin</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="table-arsip-komisi" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td><?php echo e($i); ?></td>
                                        <td><a href="<?php echo e($user->id_user == Auth::user()->id_user ? '/admin/profil' : '/admin/another/profil/'.$user->id_user); ?>"><?php echo e($user->nama_user); ?></a></td>
                            ...
                            <form id="form" class="d-none" method="post" action="/admin/delete">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-referral/resources/views//user/admin/admin.blade.php ENDPATH**/ ?>