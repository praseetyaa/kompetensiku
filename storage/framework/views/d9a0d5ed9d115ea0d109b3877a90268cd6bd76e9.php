                            ...
                            <table id="table-produk" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr data-id="<?php echo e($file->id_file); ?>">
                                        ...
                                        <td><span title="<?php echo e(date('Y-m-d H:i:s', strtotime($file->uploaded_at))); ?>" style="text-decoration: underline; cursor: help;"><?php echo e(date('Y-m-d', strtotime($file->uploaded_at))); ?></span></td>
                                        <td><a href="/admin/produk/view/<?php echo e($file->id_file); ?>" class="btn btn-info btn-sm btn-block" title="View" target="_blank"><i class="fa fa-eye"></i></a></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\campusdigital\resources\views/download/admin/index.blade.php ENDPATH**/ ?>