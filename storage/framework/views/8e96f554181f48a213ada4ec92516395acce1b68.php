<?php $__env->startSection('content'); ?>
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form method="post" action="/admin/disc/paket/keterangan/save">
        ...
        <input type="hidden" name="id_paket" value="<?php echo e(isset($keterangan) ? $keterangan->id_paket : $id); ?>">
  ...
  $(function(){
    ...
    $(document).on("click", ".delete", function(e){
      ...
      if(ask){
        $.ajax({
          type: "post",
          url: "/admin/disc/paket/keterangan/delete",
          data: {_token: "<?php echo e(csrf_token()); ?>", id: id},
          success: function(response){
            if(response == "Berhasil menghapus data!"){
              alert(response);
              window.location.href = "/admin/disc/paket/keterangan/<?php echo e($id); ?>";
            }
          }
        })
      }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\recruitment\resources\views/keterangan/admin/index.blade.php ENDPATH**/ ?>