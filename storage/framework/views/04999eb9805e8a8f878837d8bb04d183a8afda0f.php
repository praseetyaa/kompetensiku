     ...
     <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Data Materi <?php echo e($kategori->kategori); ?></h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/admin">Home</a></li>
                            <li class="breadcrumb-item"><a href="/admin/<?php echo e(strtolower($kategori->kategori)); ?>">Materi <?php echo e($kategori->kategori); ?></a></li>
                            <li class="breadcrumb-item active" aria-current="page">Data Materi <?php echo e($kategori->kategori); ?></li>
                        </ol>
                    </nav>
                </div>
            </div>
                    ...
                    <div class="card-title border-bottom">
                        <div class="row">
                            <div class="col-12 col-sm py-1 mb-2 mb-sm-0 text-center text-sm-left">
                                <h5 class="mb-0">Data Materi <?php echo e($kategori->kategori); ?></h5>
                            </div>
                            ...
                            <div class="col-12 col-sm-auto text-center text-sm-left">
								...
								<?php endif; ?>
                                <a href="/admin/<?php echo e(strtolower($kategori->kategori)); ?>/upload?dir=<?php echo e($directory->dir_folder); ?>" class="btn btn-sm btn-primary"><i class="fa fa-upload mr-2"></i> Tambah File</a>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="card-body">
						<div class="col-12 mb-4">
							...
							<?php elseif($directory->folder_parent == 1): ?>
								<strong>Folder:</strong><br><a href="/admin/<?php echo e(strtolower($kategori->kategori)); ?>?dir=/">Home</a> &raquo; <?php echo e($directory->nama_folder); ?>
						...
						<div class="table-responsive">
								...
								<tbody>
									...
									<tr class="data-folder" data-id="<?php echo e($folder->id_folder); ?>">
										<td class="td-name" data-id="<?php echo e($folder->id_folder); ?>" data-value="<?php echo e($folder->nama_folder); ?>">
											<a href="/admin/<?php echo e(strtolower($kategori->kategori)); ?>?dir=<?php echo e($folder->dir_folder); ?>">
									...
									<tr class="data-file" data-id="<?php echo e($file->id_file); ?>">
										<td class="td-name" data-id="<?php echo e($file->id_file); ?>" data-value="<?php echo e($file->nama_file); ?>">
											<a href="/admin/<?php echo e(strtolower($kategori->kategori)); ?>/view/<?php echo e($file->id_file); ?>" target="_blank">
                            ...
                            <form id="form-delete-file" class="d-none" method="post" action="/admin/<?php echo e(strtolower($kategori->kategori)); ?>/delete">
                                <?php echo e(csrf_field()); ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-add-folder" method="post" action="/admin/folder/store">
					...
					<input type="hidden" name="jenis_folder" value="<?php echo e(strtolower($kategori->id_km)); ?>">
                    <div class="row">
...
<div class="modal fade" id="modal-edit-file" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-edit-file" method="post" action="/admin/<?php echo e(strtolower($kategori->kategori)); ?>/update">
                    <?php echo e(csrf_field()); ?>

                    <div class="row">
                        <div class="form-group col-md-12">
                            <label>Nama File <span class="text-danger">*</span></label>
                            <input type="text" name="nama_produk" class="form-control <?php echo e($errors->has('nama_produk') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Nama File" value="<?php echo e(old('nama_produk')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/materi-1/admin/index.blade.php ENDPATH**/ ?>