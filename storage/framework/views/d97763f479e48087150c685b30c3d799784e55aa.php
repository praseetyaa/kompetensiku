                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="/" target="_blank">
                        ...
                        <b class="logo-icon p-l-10">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo e(asset('assets/images/logo/icon.png')); ?>" height="30" alt="homepage" class="light-logo" />
                        ...
                        <span class="logo-text ml-2">
                             <!-- dark Logo text -->
                             <img src="<?php echo e(asset('assets/images/logo/psikologanda.png')); ?>" height="30" alt="homepage" class="light-logo" />
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown shadow" aria-labelledby="2">
                                <ul class="list-style-none">
									<!--
                                    <li>
                                        <a href="/admin/request" class="link border-top">
                                            <div class="d-flex no-block align-items-center p-10">
                                                <span class="btn btn-danger btn-circle"><i class="ti-email"></i></span>
                                                <div class="m-l-10">
                                                    <h5 class="m-b-0">Request Internal</h5> 
                                                    <span class="mail-desc"><?php echo e($global_request_total); ?> pemberitahuan baru.</span> 
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                        ...
                                        <a href="/admin/komisi" class="link border-top">
                                            <div class="d-flex no-block align-items-center p-10">
                                                ...
                                                <div class="m-l-10">
                                                    ...
                                                    <span class="mail-desc"><?php echo e($global_komisi_total); ?> pemberitahuan baru.</span> 
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/admin/komisi" class="link border-top">
                                            <div class="d-flex no-block align-items-center p-10">
                                                <span class="btn btn-warning btn-circle"><i class="ti-credit-card"></i></span>
                                                <div class="m-l-10">
                                                    <h5 class="m-b-0">Pengambilan Komisi</h5> 
                                                    <span class="mail-desc"><?php echo e($global_withdrawal_total); ?> pemberitahuan baru.</span> 
                                                </div>
                                            </div>
                                        </a>
                                    </li>
        ...
        <!-- ============================================================== -->
        <!-- End Topbar header -->
        <!-- ============================================================== --><?php /**PATH /var/www/vhosts/psikologanda.com/laravel-akademi/resources/views/template/admin/_header.blade.php ENDPATH**/ ?>