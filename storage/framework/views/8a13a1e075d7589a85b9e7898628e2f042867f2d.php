        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="form-add-folder" method="post" action="/admin/folder/store">
					...
					<input type="hidden" name="jenis_folder" value="1">
                    <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/e-book/admin/index.blade.php ENDPATH**/ ?>