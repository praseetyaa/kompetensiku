        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
						<p class="mb-5">Berikut ini adalah produk-produk dari kami yang bisa Anda baca:</p>
                            ...
                            <table id="table-produk" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
											<a href="/member/produk/view/<?php echo e($file->id_file); ?>" class="btn btn-primary btn-sm btn-block" target="_blank" title="Download">
												<i class="fa fa-eye"></i>
											</a>
										</td>
                                    </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\campusdigital\resources\views/download/member/index.blade.php ENDPATH**/ ?>