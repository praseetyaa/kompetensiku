        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    <h5 class="card-title border-bottom">Tambah Paket</h5>
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/paket/store" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

                            <div class="row">
                                <div class="form-group col-md-6">
                                    <label>Nama Paket <span class="text-danger">*</span></label>
                                    <input type="text" name="nama_paket" class="form-control <?php echo e($errors->has('nama_paket') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('nama_paket')); ?>" placeholder="Masukkan Nama Paket">
								...
								<div class="form-group col-md-6">
									...
									<input type="text" name="harga_paket" class="form-control number-only thousand-format <?php echo e($errors->has('harga_paket') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('harga_paket')); ?>" placeholder="Masukkan Harga Paket">
									...
									<div class="row">
										<div class="col-auto">
											<div class="form-check form-check-inline">
												<input class="form-check-input" name="bisa_ambil_komisi" type="radio" name="inlineRadioOptions" id="inlineRadio1" value="1">
												<label class="form-check-label" for="inlineRadio1">Ya</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input" name="bisa_ambil_komisi" type="radio" name="inlineRadioOptions" id="inlineRadio2" value="0">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-referral/resources/views/paket/admin/create.blade.php ENDPATH**/ ?>