            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/admin/blog" aria-expanded="false"><i class="mdi mdi-pencil"></i><span class="hide-menu">Blog</span></a></li>
                        <?php endif; ?>
                        <?php if(Auth::user()->role == 1 || Auth::user()->role == 3): ?>
        ...
        <!-- ============================================================== --><?php /**PATH C:\xampp\htdocs\campusdigital\resources\views/template/admin/_sidebar.blade.php ENDPATH**/ ?>