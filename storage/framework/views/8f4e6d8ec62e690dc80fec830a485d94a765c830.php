<?php $__env->startSection('content'); ?>
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Tambah Tes</h1>
  <p class="mb-4">Jenis tes apa saja yang digunakan untuk menyeleksi calon karyawan.</p>

  <!-- DataTales Example -->
  <div class="card shadow mb-4">
    <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
      <h6 class="m-0 font-weight-bold text-primary">Tambah Tes</h6>
    </div>
    <div class="card-body">
      <form method="post" action="/admin/tes/store">
        <?php echo e(csrf_field()); ?>

        <div class="form-row">
          <div class="form-group col-6">
            <label>Nama Tes:</label>
            <input name="nama_tes" class="form-control <?php echo e($errors->has('nama_tes') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Nama Tes" value="<?php echo e(old('nama_tes')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/tes/admin/create.blade.php ENDPATH**/ ?>