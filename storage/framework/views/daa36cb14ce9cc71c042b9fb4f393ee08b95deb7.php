                    ...
                    <div class="card-title border-bottom">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-auto text-center text-sm-left">
								<form id="form-search" class="<?php echo e($directory->id_toolbox != 1 ? 'd-none' : ''); ?>" method="post" action="#">
                    ...
                    <div class="card-body">
						<div class="col-12 mb-4">
							...
							<?php elseif($directory->toolbox_parent == 1): ?>
								<strong>Folder:</strong> <a href="/member/tools?dir=/">Home</a> / <?php echo e($directory->nama_toolbox); ?>
						...
						<div class="col-12">
							<div class="row" id="data-folder">
								...
								<a class="col-md-6 col-lg-3 col-xlg-3" href="/member/tools?dir=<?php echo e($toolbox->dir_toolbox); ?>">
									<div class="card card-hover shadow">
										<div class="box text-center">
											<?php if(date('Y-m-d') == date('Y-m-d', strtotime($toolbox->modified_at))): ?><div class="badge-new text-success">Baru!</div><?php endif; ?>
											<img src="<?php echo e($toolbox->toolbox_icon != '' ? asset('assets/images/toolbox/'.$toolbox->toolbox_icon) : asset('assets/images/default/toolbox.png')); ?>" height="100">
											<h6 class="text-dark mt-2"><?php echo e($toolbox->nama_toolbox); ?></h6>
											<p class="mb-0 text-secondary">(<?php echo e(count_tools($toolbox->id_toolbox)); ?> file)</p>
										</div>
									</div>
								</a>
							...
							<div class="row" id="data-file">
								<?php if(count($toolboxes)>0 || count($tools)>0): ?>
									<?php $__currentLoopData = $tools; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tool): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-md-6 col-lg-3 col-xlg-3">
                                        <div class="card card-hover shadow">
											<?php if(date('Y-m-d') == date('Y-m-d', strtotime($tool->uploaded_at))): ?><div class="badge-new text-success">Baru!</div><?php endif; ?>
                                            <a href="<?php echo e(asset('assets/tools/'.$tool->nama_tool.'.'.mime_to_ext($tool->tipe_tool)[0])); ?>">
                                                <img class="card-img-top" src="<?php echo e($tool->thumbnail_tool != '' ? asset('assets/images/tool/'.$tool->thumbnail_tool) : asset('assets/images/default/tool.png')); ?>" alt="Gambar">
                                            </a>
                                            <div class="card-body text-center">
												<h6 class="text-dark mt-2"><?php echo e($tool->nama_tool.'.'.mime_to_ext($tool->tipe_tool)[0]); ?></h6>
												<p class="mb-0 text-secondary">(<?php echo e(generate_size($tool->ukuran_tool)); ?>)</p>
                                            </div>
                                        </div>
                                    </div>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			...
			$.ajax({
				...
				success: function(response){
					...
					$(result.folders).each(function(key,data){
						...
						html += data.toolbox_icon != '' ? '<img src="<?php echo e(asset('assets/images/toolbox')); ?>/'+data.toolbox_icon+'" height="100">' : '<img src="<?php echo e(asset('assets/images/default/toolbox.png')); ?>" height="100">' ;
					...
					$(result.files).each(function(key,data){
                        ...
                        html2 += '<a href="<?php echo e(asset('assets/tools')); ?>/'+data.nama_tool+'">';
                        html2 += data.thumbnail_tool != '' ? '<img class="card-img-top" src="<?php echo e(asset('assets/images/tool')); ?>/'+data.thumbnail_tool+'">' : '<img class="card-img-top" src="<?php echo e(asset('assets/images/default/tool.png')); ?>">';
                        html2 += '</a>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/tool/member/index.blade.php ENDPATH**/ ?>