            ...
            <div class="form-row">
              <div class="form-group col-sm-6">
                ...
                <div class="input-group">
                  <input name="pas_foto" type="text" class="form-control form-control-sm <?php echo e($errors->has('pas_foto') ? 'is-invalid' : ''); ?>" value="<?php echo e(is_int(strpos($previousPath, 'step-')) ? Session::get('pas_foto') : old('pas_foto')); ?>" readonly>
                ...
                <div class="row">
                  <div class="col">
                    <img name="img_pas_foto" class="img-thumbnail <?php echo e(Session::has('pas_foto') != null ? '' : 'd-none'); ?> mt-3" width="200" src="<?php echo e(Session::has('pas_foto') != null ? asset('assets/images/pas-foto/'.Session::get('pas_foto')) : ''); ?>">
              ...
              <div class="form-group col-sm-6">
                ...
                <div class="input-group">
                  <input name="foto_ijazah" type="text" class="form-control form-control-sm <?php echo e($errors->has('foto_ijazah') ? 'is-invalid' : ''); ?>" value="<?php echo e(is_int(strpos($previousPath, 'step-')) ? Session::get('foto_ijazah') : old('foto_ijazah')); ?>" readonly>
                  <div class="input-group-append">
                ...
                <div class="row">
                  <div class="col">
                    <img name="img_foto_ijazah" class="img-thumbnail <?php echo e(Session::has('foto_ijazah') != null ? '' : 'd-none'); ?> mt-3" width="200" src="<?php echo e(Session::has('foto_ijazah') != null ? asset('assets/images/foto-ijazah/'.Session::get('foto_ijazah')) : ''); ?>">
...
</html><?php /**PATH D:\XAMPP\htdocs\recruitment\resources\views/auth/applicant/register-step-2.blade.php ENDPATH**/ ?>