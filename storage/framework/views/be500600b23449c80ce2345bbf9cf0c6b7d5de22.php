                ...
                <div class="navbar-header" data-logobg="skin5">
                    ...
                    <a class="navbar-brand" href="/" target="_blank">
                        ...
                        <span class="logo-text ml-2">
                             <!-- dark Logo text -->
                             Admin Area
                             <!-- <img src="<?php echo e(asset('assets/images/logo/'.get_logo())); ?>" height="30" alt="homepage" class="light-logo" /> -->
                    ...
                    <ul class="navbar-nav float-right">
                                        ...
                                        <a href="/admin/transaksi/pelatihan" class="link border-top">
                                            <div class="d-flex no-block align-items-center p-10">
                                                ...
                                                <div class="m-l-10">
                                                    ...
                                                    <span class="mail-desc"><?php echo e($global_pelatihan_member_total); ?> pemberitahuan baru.</span> 
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right user-dd animated">
                                ...
                                <?php if(Auth::user()->role == role_manajer() || Auth::user()->role == role_mentor()): ?>
        ...
        <!-- ============================================================== -->
        <!-- End Topbar header -->
        <!-- ============================================================== --><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/template/admin/_header.blade.php ENDPATH**/ ?>