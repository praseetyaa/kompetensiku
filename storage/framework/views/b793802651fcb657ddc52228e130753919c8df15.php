    ...
    <div class="row">
      <div class="col-lg-8"> 
        <div class="info-text">
		  ...
		  <div class="row mt-3">
			  <div class="col-12">
				  <img src="<?php echo e($blog->blog_gambar != '' ? asset('assets/images/blog/'.$blog->blog_gambar) : asset('assets/images/blog/default.jpg')); ?>" class="img-fluid">
			  </div>
		  </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/guest/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-v3/resources/views/artikel/guest/post.blade.php ENDPATH**/ ?>