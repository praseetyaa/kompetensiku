                    ...
                    <div class="col-md-6 mx-md-auto">
                        <div class="card shadow">
                            ...
                            <div class="card-body text-center">
								...
								<input type="hidden" name="id_toolbox" id="id_toolbox" value="<?php echo e($directory->id_toolbox); ?>">
                            ...
                            <div class="border-top">
                                <a href="/admin/tools?dir=<?php echo e($directory->dir_toolbox); ?>" class="btn btn-block btn-warning">Kembali ke Kumpulan Tools</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
	...
	function progressHandler(event){
		...
		if(Math.round(percent) == 100){
			...
			$("#file").val(null);
			window.location.href = '/admin/tools?dir=<?php echo e($directory->dir_toolbox); ?>';
		}
		else{
            $("#btn-upload").attr("disabled","disabled");
		}
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/tool/admin/upload.blade.php ENDPATH**/ ?>