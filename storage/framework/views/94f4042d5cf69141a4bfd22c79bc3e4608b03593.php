            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="/admin/rekening" aria-expanded="false"><i class="mdi mdi-credit-card"></i><span class="hide-menu">Rekening</span></a></li>
        ...
        <!-- ============================================================== --><?php /**PATH D:\XAMPP\htdocs\pra-kerja\resources\views/template/admin/_sidebar.blade.php ENDPATH**/ ?>