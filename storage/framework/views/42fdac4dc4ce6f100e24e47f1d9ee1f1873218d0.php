                                ...
                                <div class="form-group col-md-12">
									<div class="row">
										<div class="col-md-6">
											...
											<input type="text" name="waktu_aktif" id="daterangepicker" class="form-control <?php echo e($errors->has('waktu_aktif') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Waktu Aktif Pop-up" value="<?php echo e(old('waktu_aktif')); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/pop-up/admin/create.blade.php ENDPATH**/ ?>