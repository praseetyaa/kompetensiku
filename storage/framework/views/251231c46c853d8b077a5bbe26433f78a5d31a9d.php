                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4" style="border-left: 1px solid #bebebe;">
                                ...
                                <ul>
                                    ...
                                    <li><a class="<?php echo e($course->id_course == $data->id_course ? 'font-weight-bold' : ''); ?>" href="/member/e-course/detail/<?php echo e($data->id_course); ?>">Chapter <?php echo e($data->chapter_nomor); ?>.<?php echo e($data->course_nomor); ?>: <?php echo e($data->course_judul); ?></a></li>
...
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-v3/resources/views/e-course/member/detail.blade.php ENDPATH**/ ?>