...
<head>
    ...
    <style type="text/css">
		...
		.header-section {background: linear-gradient(180deg, black, transparent);}
        .header-right .hr-btn {padding: 28px 30px; margin-right: 15px; opacity: 0.7; line-height: 1;}
        .header-right .hr-btn:hover {opacity: 1; transition: .2s ease-in;}
    	.header-right .hr-btn.hr-btn-2 {padding: 28px 30px; min-width: auto; margin-right: 15px;}
...
<?php /**PATH /var/www/vhosts/campusdigital.id/laravel-referral/resources/views/template/guest/main.blade.php ENDPATH**/ ?>