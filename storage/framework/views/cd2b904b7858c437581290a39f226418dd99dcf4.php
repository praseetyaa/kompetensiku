                        ...
                        <form id="form" method="post" action="/admin/platform/update" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
									...
									<br>
                                    <input type="file" id="file" name="logo_platform">
									<input type="hidden" name="current_logo" value="<?php echo e($platform->logo_platform); ?>">
									<br>
									<img id="logo-platform" class="img-thumbnail mt-3" src="<?php echo e($platform->logo_platform != '' ? asset('assets/images/platform/'.$platform->logo_platform) : ''); ?>" style="<?php echo e($platform->logo_platform != '' ? 'display:block' : 'display:none'); ?>">
...
<style type="text/css">
	...
	#logo-platform {max-width: 300px;}
</style>

<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-referral/resources/views/platform/admin/edit.blade.php ENDPATH**/ ?>