 ...
 <div class="bradcam_area breadcam_bg overlay" style="background-image: url('<?php echo e(asset('assets/images/others/slider-1.jpg')); ?>');">
	...
	<section class="sample-text-area">
		<div class="container box_1170">
			<h3 class="text-heading">Artikel</h3>
            <div class="row">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/guest/br/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kompetensiku.id/public_html/bisa-v2/resources/views/front/br/posts.blade.php ENDPATH**/ ?>