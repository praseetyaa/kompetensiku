                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/konten-web/testimoni/update" enctype="multipart/form-data">
							...
							<input type="hidden" name="id" value="<?php echo e($testimoni->id_testimoni); ?>">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Nama Klien <span class="text-danger">*</span></label>
                                    <input type="text" name="nama_klien" class="form-control <?php echo e($errors->has('nama_klien') ? 'is-invalid' : ''); ?>" value="<?php echo e($testimoni->klien); ?>" placeholder="Masukkan Nama Klien">
                                    <?php if($errors->has('nama_klien')): ?>
                                    <small class="text-danger"><?php echo e(ucfirst($errors->first('nama_klien'))); ?></small>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group col-md-12">
									...
									<br>
									<img id="img-file" src="<?php echo e($testimoni->foto_klien != '' ? asset('assets/images/testimoni/'.$testimoni->foto_klien) : ''); ?>" class="mt-2 img-thumbnail <?php echo e($testimoni->foto_klien != '' ? '' : 'd-none'); ?>" style="max-height: 150px">
									<input type="hidden" name="gambar" id="src-img">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>Profesi Klien <span class="text-danger">*</span></label>
                                    <input type="text" name="profesi_klien" class="form-control <?php echo e($errors->has('profesi_klien') ? 'is-invalid' : ''); ?>" value="<?php echo e($testimoni->profesi_klien); ?>" placeholder="Masukkan Profesi Klien">
                                    <?php if($errors->has('profesi_klien')): ?>
                                    <small class="text-danger"><?php echo e(ucfirst($errors->first('profesi_klien'))); ?></small>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group col-md-12">
                                    <label>Testimoni <span class="text-danger">*</span></label>
                                    <textarea name="testimoni" class="form-control <?php echo e($errors->has('testimoni') ? 'is-invalid' : ''); ?>" rows="5" placeholder="Masukkan Testimoni"><?php echo e($testimoni->testimoni); ?></textarea>
                                    <?php if($errors->has('testimoni')): ?>
                                    <small class="text-danger"><?php echo e(ucfirst($errors->first('testimoni'))); ?></small>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </form>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/testimoni/admin/edit.blade.php ENDPATH**/ ?>