...
<head>
    ...
    <style type="text/css">
    	...
    	.main-menu li a {padding: 58px 5px; margin-right: 30px;}
        .header-right .hr-btn {padding: 36px 30px; margin-right: 15px; opacity: 0.7;}
        .header-right .hr-btn:hover {opacity: 1; transition: .2s ease-in;}
    	.header-right .hr-btn.hr-btn-2 {min-width: auto; margin-right: 15px;}
...
<?php /**PATH D:\XAMPP\htdocs\pra-kerja\resources\views/template/guest/main.blade.php ENDPATH**/ ?>