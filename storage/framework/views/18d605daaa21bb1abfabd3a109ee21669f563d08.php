                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-hover bg-cyan shadow">
                            <div class="card-body text-center">
                                <h4>URL Referral</h4>
                                <p class="mb-0 h5"><a class="text-light font-weight-bold" href="<?php echo e(URL::to('/')); ?>?ref=<?php echo e($user->referral_code); ?>" target="_blank"><?php echo e(URL::to('/')); ?>?ref=<?php echo e($user->referral_code); ?></a></p>
                            </div>
                        </div>
                    </div>
                    <!-- column -->
                    ...
                    <div class="col-lg-12">
                        <div class="card card-hover bg-warning shadow">
                            <div class="card-body text-center">
                                <h4>Total Komisi</h4>
                                <p class="mb-0 h3 font-weight-bold <?php echo e($user->komisi >= minWithdrawal() ? 'text-primary' : 'text-danger'); ?>">Rp. <?php echo e(number_format($user->komisi,0,',','.')); ?></p>
                            </div>
                        </div>
                    </div>
                    <!-- column -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
						...
						<div class="card shadow">
							<h5 class="card-title border-bottom">Paket</h5>
							<div class="card-body">
								<form id="form-paket" method="post" action="/admin/member/update-paket">
									<?php echo e(csrf_field()); ?>

									<input type="hidden" name="id" value="<?php echo e($user->id_user); ?>">
									<?php if(Session::get('updatePaket') != null): ?>
									<div class="alert alert-success alert-dismissible mb-4 fade show" role="alert">
										<?php echo e(Session::get('updatePaket')); ?>
									...
									<div class="row">
										<div class="form-group col-md-12">
											<select name="paket" class="form-control" disabled>
												...
												<option value="<?php echo e($data->id_paket); ?>" <?php echo e($data->id_paket == $user->paket ? 'selected' : ''); ?>><?php echo e($data->nama_paket); ?></option>
												<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
											</select>
											<div class="text-muted mt-2">
												Dengan menggunakan paket <strong><?php echo e($user->nama_paket); ?></strong>, maka User <u><?php echo e($user->bisa_ambil_komisi == 1 ? 'dapat' : 'tidak dapat'); ?></u> mencairkan komisi.
											</div>
										</div>
									</div>
								</form>
						...
						<div class="card shadow">
							...
							<div class="card-body">
								<form id="form-identity" method="post" action="/admin/member/update">
									<?php echo e(csrf_field()); ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-auto mx-auto p-0">
                                        <img src="<?php echo e($user->foto != '' ? asset('assets/images/users/'.$user->foto) : asset('templates/matrix-admin/assets/images/users/1.jpg')); ?>" class="img-thumbnail img-fluid" id="image" height="200" width="200">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div><?php echo e(setFullDate(date('Y-m-j', strtotime($user->created_at)))); ?> pukul <?php echo e(date('H:i:s', strtotime($user->created_at))); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<div class="modal fade" id="modalGaleri" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="form-choose-photo" class="d-none" method="post" action="/admin/member/pilih-foto">
                <?php echo e(csrf_field()); ?>
...
<div class="modal fade" id="modalCroppie" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form id="form-profile-image" class="d-none" method="post" action="/admin/member/update-foto">
                <?php echo e(csrf_field()); ?>
...
<script type="text/javascript">
	...
	// Change Paket
	$(document).on("change", "select[name=paket]", function(){
		var id_paket = $(this).val();
		var nama_paket = $(this).find("option[value="+id_paket+"]").text();
		var ask = confirm("Anda yakin ingin mengganti paket menjadi "+nama_paket+" ?");
		if(ask){
        	$("#form-paket").submit();
      		$(this).find("option[value=<?php echo e($user->paket); ?>]").prop("selected",true);
		}
	});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-referral/resources/views/user/admin/member-profile.blade.php ENDPATH**/ ?>