      ...
      <div class="card my-auto">
        ...
        <div class="card-body">
          <div class="text-center">
            <h1 class="h4 text-gray-900 mb-5 text-uppercase">Form Login Akun</h1>
          </div>
          <form method="post" action="/applicant/register/step-3" enctype="multipart/form-data">
            ...
            <div class="form-row">
              <div class="form-group col-sm-6">
                ...
                <input name="username" type="text" class="form-control form-control-sm <?php echo e($errors->has('username') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Username" value="<?php echo e(old('username')); ?>">
              ...
              <div class="form-group col-sm-6">
                ...
                <div class="input-group">
                  <input name="password" type="password" class="form-control form-control-sm <?php echo e($errors->has('password') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Password">
                  <div class="input-group-append">
                    <button class="btn btn-sm <?php echo e($errors->has('password') ? 'btn-outline-danger' : 'btn-outline-primary'); ?> btn-toggle-password show" type="button"><i class="fa fa-eye"></i></button>
                  </div>
                </div>
...
</html><?php /**PATH D:\XAMPP\htdocs\recruitment\resources\views/auth/applicant/register-step-3.blade.php ENDPATH**/ ?>