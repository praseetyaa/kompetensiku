...
<div class="slider_area">
    <div class="slider_active owl-carousel">
        <div class="single_slider d-flex align-items-center justify-content-center overlay" style="background-image: url('<?php echo e(asset('assets/images/others/slider-1.jpg')); ?>');">
            <div class="container">
                <div class="row">
        ...
        <div class="single_slider d-flex align-items-center justify-content-center overlay" style="background-image: url('<?php echo e(asset('assets/images/others/slider-2.jpg')); ?>');">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        <div class="slider_text">
        ...
        <div class="single_slider d-flex align-items-center justify-content-center overlay" style="background-image: url('<?php echo e(asset('assets/images/others/slider-3.jpg')); ?>');">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 col-md-12">
                        <div class="slider_text">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/guest/br/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/kompetensiku.id/public_html/bisa-v2/resources/views/front/br/home.blade.php ENDPATH**/ ?>