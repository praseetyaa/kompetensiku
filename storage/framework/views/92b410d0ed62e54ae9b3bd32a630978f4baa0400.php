			...
			<div class="card">
				...
				<div class="card-body">
					<form id="registration-form" method="post" action="/register">
					  ...
					  <input type="hidden" name="ref" value="<?php echo e($user == null ? $default->referral_code : $user->referral_code); ?>">
					  <div class="alert alert-warning text-center">
						<strong>Sponsor:</strong> <?php echo e($user == null ? $default->nama_user : $user->nama_user); ?>

					  </div>
					  <p class="h6 text-center font-weight-bold mb-3 mt-5">Paket</p>
					  <div class="form-group">
						<label>Pilih Paket <span class="text-danger">*</span></label>
						  <div class="form-row">
							  <?php $__currentLoopData = $paket; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							  <div class="col">
								  <div class="form-check">
								  	<input class="form-check-input" type="radio" name="paket" id="radio-<?php echo e($key); ?>" value="<?php echo e($data->id_paket); ?>" <?php echo e($key == 0 ? 'checked' : ''); ?>>
								  	<label class="form-check-label" for="radio-<?php echo e($key); ?>">
										<?php echo e($data->nama_paket); ?> (Rp. <?php echo e(number_format($data->harga_paket,0,'.','.')); ?>,-)
								  	</label>
								  </div>
							  </div>
...
<style type="text/css">
  .header-section {background: #22242b!important;}
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/guest/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-referral/resources/views/front/register.blade.php ENDPATH**/ ?>