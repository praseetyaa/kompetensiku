        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    <h5 class="card-title border-bottom">Tambah Program</h5>
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/program/store" enctype="multipart/form-data">
                            <?php echo e(csrf_field()); ?>

                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Judul <span class="text-danger">*</span></label>
                                    <input type="text" name="judul_program" class="form-control <?php echo e($errors->has('judul_program') ? 'is-invalid' : ''); ?>" value="<?php echo e(old('judul_program')); ?>" placeholder="Masukkan Judul Program">
                                ...
                                <div class="form-group col-md-12">
									...
									<select name="kategori" class="form-control col-md-4  <?php echo e($errors->has('kategori') ? 'is-invalid' : ''); ?>">
										...
										<option value="1" <?php echo e(old('kategori') == 1 ? 'selected' : ''); ?>>Online Class</option>
										<option value="2" <?php echo e(old('kategori') == 2 ? 'selected' : ''); ?>>Online Course</option>
										<option value="3" <?php echo e(old('kategori') == 3 ? 'selected' : ''); ?>>Workshop</option>
										<option value="4" <?php echo e(old('kategori') == 4 ? 'selected' : ''); ?>>Sertifikasi</option>
									</select>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/psikologanda.com/laravel-akademi/resources/views/program/admin/create.blade.php ENDPATH**/ ?>