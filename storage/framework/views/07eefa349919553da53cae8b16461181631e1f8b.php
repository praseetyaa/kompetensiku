                ...
                <div class="card shadow">
                    <div class="card-body text-justify">
                        ...
                        <div class="m-t-20 m-b-20">
                            ...
                            <p class="mb-1">Aktivasi akun Anda dengan melakukan pembayaran sejumlah <strong>Rp. <?php echo e(number_format($komisi->komisi_aktivasi,0,'.','.')); ?></strong> ke rekening berikut:</p>
                            <ol>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\campusdigital\resources\views/dashboard/member/dashboard.blade.php ENDPATH**/ ?>