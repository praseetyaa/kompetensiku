    ...
    <div class="row no-gutters slider-text align-items-end">
      <div class="col-md-12 ftco-animate my-auto">
        <p class="breadcrumbs mb-2">
          ...
          <span>Registrasi <i class="ion-ios-arrow-forward"></i></span></p>
        <h1 class="mb-0 bread">Registrasi</h1>
      </div>
    </div>
  </div>
</section>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/guest/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms\resources\views/front/register.blade.php ENDPATH**/ ?>