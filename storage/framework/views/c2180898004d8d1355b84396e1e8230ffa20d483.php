            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item <?php echo e(strpos(Request::url(), '/member/transaksi') || strpos(Request::url(), '/member/rekening') || strpos(Request::url(), '/member/script') || strpos(Request::url(), '/member/afiliasi') ? 'selected' : ''); ?>"> <a class="sidebar-link has-arrow waves-effect waves-dark <?php echo e(strpos(Request::url(), '/member/transaksi') || strpos(Request::url(), '/member/rekening') || strpos(Request::url(), '/member/script') || strpos(Request::url(), '/member/afiliasi') ? 'active' : ''); ?>" href="javascript:void(0)" aria-expanded="false"><i class="mdi mdi-credit-card-scan"></i><span class="hide-menu">Afiliasi</span></a>
                            <ul aria-expanded="false" class="collapse first-level <?php echo e(strpos(Request::url(), '/member/transaksi') || strpos(Request::url(), '/member/rekening') || strpos(Request::url(), '/member/script') || strpos(Request::url(), '/member/afiliasi') ? 'in' : ''); ?>">
                                ...
                                <li class="sidebar-item <?php echo e(strpos(Request::url(), '/member/script') ? 'active' : ''); ?>"><a href="/member/script" class="sidebar-link"><i class="mdi mdi-chevron-right"></i><span class="hide-menu">Script Jualan</span></a></li>
        ...
        <!-- ============================================================== --><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-v3/resources/views/template/member/_sidebar.blade.php ENDPATH**/ ?>