									...
									<tr class="data-folder" data-id="<?php echo e($folder->id_folder); ?>">
                                        ...
                                        <td>
											<span title="<?php echo e(date('Y-m-d H:i:s', strtotime($folder->modified_at))); ?>" style="text-decoration: underline; cursor: help;">
												<?php echo e($folder->modified_at != null ? date('Y-m-d', strtotime($folder->modified_at)) : ''); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/bisa.co.id/public_html/bisa-v2/resources/views/materi/admin/index.blade.php ENDPATH**/ ?>