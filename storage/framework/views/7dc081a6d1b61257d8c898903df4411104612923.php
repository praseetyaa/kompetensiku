                                ...
                                <tr>
                                    <td class="content-cell">
										<table class="subcopy" width="100%" cellpadding="0" cellspacing="0" role="presentation">
											<tr id="tr-logo">
												<td align="center">
													<img id="logo" src="<?php echo e(asset('assets/images/logo/'.get_logo())); ?>" width="250">
												</td>
											</tr>
											<tr>
												<td id="td-content">
													...
													<br>
													Anda telah berhasil melakukan pendaftaran. Segera aktivasi akun Anda supaya dapat menggunakan fasilitas dari <?php echo e(get_website_name()); ?>, dengan cara melakukan pembayaran sejumlah <strong>Rp. <?php echo e(number_format($komisi->komisi_aktivasi,0,'.','.')); ?></strong> ke rekening berikut:
													<br>
													<ol>
...
<?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/email/register.blade.php ENDPATH**/ ?>