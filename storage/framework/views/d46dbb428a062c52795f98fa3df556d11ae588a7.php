    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="/admin/tahap-administrasi">
          <i class="fas fa-fw fa-user-check"></i>
          <span>Tahap Administrasi</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/admin/tahap-wawancara">
          <i class="fas fa-fw fa-user-shield"></i>
          <span>Tahap Wawancara</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="/admin/hasil-disc">
          <i class="fas fa-fw fa-chart-line"></i>
          <span>Hasil DISC</span></a>
      </li>
      ...
      <!-- Nav Item - Pages Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link" href="/admin/disc">
...
<!--       <li class="nav-item">
    ...
    <!-- End of Sidebar --><?php /**PATH D:\XAMPP\htdocs\recruitment\resources\views/template/admin/_sidebar.blade.php ENDPATH**/ ?>