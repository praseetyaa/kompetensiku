      ...
      <form method="post" action="/admin/role/update">
        ...
        <div class="form-row">
          <div class="form-group col-6">
            ...
            <input name="nama_role" class="form-control <?php echo e($errors->has('nama_role') ? 'is-invalid' : ''); ?>" placeholder="Masukkan Nama Role" value="<?php echo e($role->nama_role); ?>">
        ...
        <div class="form-group">
          <input type="hidden" name="id_role" value="<?php echo e($role->id_role); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/role/admin/edit.blade.php ENDPATH**/ ?>