...
<div class="preloader-2">
	<div class="preloader-animation" style="background-image: url(<?php echo e(asset('assets/loaders/preloader.gif')); ?>);"></div>
</div>
<!-- ============================================================== -->
<!-- Page wrapper  -->
<!-- ============================================================== -->
                ...
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="/admin/materi/<?php echo e(generate_permalink($kategori->kategori)); ?>">Materi <?php echo e($kategori->kategori); ?></a></li>
                    ...
                    <div class="col-md-6 mx-md-auto">
                        <div class="card shadow">
                            ...
                            <div class="card-body text-center">
								...
								<input type="hidden" name="id_folder" id="id_folder" value="<?php echo e($directory->id_folder); ?>">
								<input type="hidden" name="jenis_file" id="jenis_file" value="<?php echo e($kategori->id_km); ?>">
                            ...
                            <div class="border-top">
                                <a href="/admin/materi/<?php echo e(generate_permalink($kategori->kategori)); ?>?dir=<?php echo e($directory->dir_folder); ?>" class="btn btn-block btn-warning">Kembali ke Materi <?php echo e($kategori->kategori); ?></a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript" src="<?php echo e(asset('assets/plugins/pdf.js/pdf.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/plugins/pdf.js/pdf.worker.js')); ?>"></script>
<script type="text/javascript">
    ...
    $(document).on("click", "#btn-upload", function(e){
		...
		if($("#nama_file").val() == null || $("#nama_file").val() == ''){
			...
			$.ajax({
				type: 'post',
				url: '/admin/materi/<?php echo e(generate_permalink($kategori->kategori)); ?>/upload',
				data: {
				...
				$.ajax({
					...
					success: function(){
						if(i == canvases.length){
							...
							window.location.href = '/admin/materi/<?php echo e(generate_permalink($kategori->kategori)); ?>?dir=<?php echo e($directory->dir_folder); ?>';
						}
						i++;
					}
				});
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/materi/admin/upload.blade.php ENDPATH**/ ?>