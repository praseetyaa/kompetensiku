<?php $__env->startSection('content'); ?>
  ...
  <div class="card shadow mb-4">
    ...
    <div class="card-body">
      <form method="post" action="/admin/tes/tipe/<?php echo e($id_tes); ?>/paket/tutorial/save">
  ...
  $(function(){
    ...
    $(document).on("click", ".delete", function(e){
      ...
      if(ask){
        $.ajax({
          type: "post",
          url: "/admin/tes/tipe/<?php echo e($id_tes); ?>/paket/tutorial/delete",
          data: {_token: "<?php echo e(csrf_token()); ?>", id: id},
          success: function(response){
            if(response == "Berhasil menghapus data!"){
              alert(response);
              window.location.href = "/admin/tes/tipe/<?php echo e($id_tes); ?>/paket/tutorial/<?php echo e($id_paket); ?>";
            }
          }
        })
      }
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/tutorial/admin/tutorial.blade.php ENDPATH**/ ?>