                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/konten-web/mitra/update" enctype="multipart/form-data">
							...
							<input type="hidden" name="id" value="<?php echo e($mitra->id_mitra); ?>">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Nama Mitra <span class="text-danger">*</span></label>
                                    <input type="text" name="nama_mitra" class="form-control <?php echo e($errors->has('nama_mitra') ? 'is-invalid' : ''); ?>" value="<?php echo e($mitra->nama_mitra); ?>" placeholder="Masukkan Nama Mitra">
                                ...
                                <div class="form-group col-md-12">
									...
									<br>
									<img id="img-file" src="<?php echo e($mitra->logo_mitra != '' ? asset('assets/images/mitra/'.$mitra->logo_mitra) : ''); ?>" class="mt-2 img-thumbnail <?php echo e($mitra->logo_mitra != '' ? '' : 'd-none'); ?>" style="max-height: 150px">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/public_html/laravel-v3/resources/views/mitra/admin/edit.blade.php ENDPATH**/ ?>