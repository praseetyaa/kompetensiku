          ...
          <div class="col-md-6">
            <div class="row">
              <div class="form-group col-md-12">
                ...
                <div class="row">
                  <?php if(count($posisi->keahlian)>0): ?>
                    <?php $__currentLoopData = $posisi->keahlian; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="col-12 mb-2 input-keahlian" data-id="<?php echo e(($key+1)); ?>">
                        <div class="input-group">
                          <input name="keahlian[]" type="text" class="form-control" placeholder="Masukkan Keahlian" value="<?php echo e($data); ?>">
                          <div class="input-group-append">
                            <button class="btn btn-outline-success btn-add" type="button" data-id="<?php echo e(($key+1)); ?>" title="Tambah"><i class="fa fa-plus"></i></button>
                            <button class="btn btn-outline-danger btn-delete" type="button" data-id="<?php echo e(($key+1)); ?>" title="Hapus"><i class="fa fa-trash"></i></button>
                          </div>
                        </div>
                      </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/posisi/admin/edit.blade.php ENDPATH**/ ?>