      ...
      <div class="card my-auto">
        <div class="card-body">
          <div class="text-center">
            <h1 class="h4 text-gray-900 mb-5 text-uppercase">Pendaftaran Berhasil!</h1>
            <div class="col">
              <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="<?php echo e(asset('templates/sb-admin-2/img/undraw_ideas_flow.svg')); ?>" alt="">
            </div>
            <a href="/" class="btn btn-sm btn-primary mt-3">Kembali ke Home</a>
          </div>
        </div>
      </div>
    </div>
...
</html><?php /**PATH D:\XAMPP\htdocs\recruitment2\resources\views/auth/applicant/success.blade.php ENDPATH**/ ?>