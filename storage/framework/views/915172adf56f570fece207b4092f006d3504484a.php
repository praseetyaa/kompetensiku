  ...
  <div class="container text-center text-lg-left h-100">
    <div class="row h-100">
      <div class="col-lg-12 my-auto">
        <div class="hs-text">
          	<h2 data-aos="fade-down" data-aos-duration="1000">Let's Join Us! <?php echo e(var_dump(template_app())); ?></h2>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/guest/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\lms-v2\resources\views/front/home.blade.php ENDPATH**/ ?>