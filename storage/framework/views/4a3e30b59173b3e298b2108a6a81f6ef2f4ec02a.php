                            ...
                            <div class="row">
								...
								<div class="form-group col-md-6">
									...
									<select name="kategori" class="form-control <?php echo e($errors->has('kategori') ? 'is-invalid' : ''); ?>" >
										...
										<option value="1" <?php echo e(old('kategori') == 1 ? 'selected' : ''); ?>>Webinar</option>
										<option value="2" <?php echo e(old('kategori') == 2 ? 'selected' : ''); ?>>Seminar</option>
									</select>
								...
								<div class="form-group col-md-6">
									...
									<div class="row">
										<div class="col-md-6">
											<input type="text" name="tanggal_pelatihan" class="form-control <?php echo e($errors->has('tanggal_pelatihan') ? 'border-danger' : ''); ?>" value="<?php echo e(old('tanggal_pelatihan')); ?>" placeholder="Masukkan Tanggal Pelatihan (Format: yyyy-mm-dd)">
										...
										<div class="col-md-6">
											<input type="text" name="jam_pelatihan" class="form-control <?php echo e($errors->has('jam_pelatihan') ? 'border-danger' : ''); ?>" value="<?php echo e(old('jam_pelatihan')); ?>" placeholder="Masukkan Jam Pelatihan">
											<?php if($errors->has('tanggal_pelatihan')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/pelatihan/admin/create.blade.php ENDPATH**/ ?>