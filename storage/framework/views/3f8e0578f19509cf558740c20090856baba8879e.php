     ...
     <div class="page-breadcrumb">
        <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
                <h4 class="page-title">Baca E-Competence</h4>
                <div class="ml-auto text-right">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/member">Home</a></li>
                            <li class="breadcrumb-item"><a href="/member/e-competence">Materi E-Competence</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Baca E-Competence</li>
                        </ol>
                    </nav>
                </div>
            </div>
						...
						<div class="row">
							<div class="col-md-10 col-12 mx-auto">
								<?php $__currentLoopData = $file_detail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									?>
									<p class="mb-1"><?php echo e(substr($explode_strip[1],0,1) == '0' ? substr($explode_strip[1],1,1) : $explode_strip[1]); ?> / <?php echo e(count($file_detail)); ?></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/e-competence/member/view.blade.php ENDPATH**/ ?>