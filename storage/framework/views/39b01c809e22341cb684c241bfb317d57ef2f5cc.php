            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    <div class="card-title border-bottom">
                        <div class="row">
                            <div class="col-12 col-sm py-1 mb-2 mb-sm-0 text-center text-sm-left">
                                <h5 class="mb-0">Rekening Campus Digital</h5>
                            </div>
                            <div class="col-12 col-sm-auto text-center text-sm-left">
                                <a href="/admin/default-rekening/create" class="btn btn-sm btn-primary"><i class="fa fa-plus mr-2"></i> Tambah Rekening</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="table-default-rekening" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($data->nomor); ?></td>
                                        <td><?php echo e($data->atas_nama); ?></td>
                                        <td><a href="/admin/default-rekening/edit/<?php echo e($data->id_dr); ?>" class="btn btn-warning btn-sm btn-block" title="Edit"><i class="fa fa-edit"></i></a></td>
                            ...
                            <form id="form-dr" class="d-none" method="post" action="/admin/default-rekening/delete">
                                <?php echo e(csrf_field()); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/admin/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/rekening/admin/index.blade.php ENDPATH**/ ?>