            ...
            <div class="col-lg-5">
                ...
                <div class="card shadow">
                            ...
                            <div class="row">
                                <div class="form-group col-12">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="withdrawal" class="form-control number-only thousand-format <?php echo e($errors->has('withdrawal_hidden') ? 'border-danger' : ''); ?>" value="<?php echo e(old('withdrawal')); ?>" placeholder="Masukkan nominal withdrawal yang akan diambil" <?php echo e(Auth::user()->saldo < minWithdrawal() || $current_withdrawal ? 'disabled' : ''); ?>>
                                        <input type="hidden" name="withdrawal_hidden" value="<?php echo e(old('withdrawal_hidden')); ?>">
                                    </div>
                                    <div class="row mt-1">
                                        <?php if($errors->has('withdrawal_hidden')): ?>
                                        <small class="col-12 text-danger">Nominal withdrawal yang dapat diambil yaitu antara Rp. <?php echo e(number_format(minWithdrawal(),0,',','.')); ?> dan Rp. <?php echo e(number_format(Auth::user()->saldo,0,',','.')); ?>.</small>
                                        <?php else: ?>
                                        <small class="col-12 text-muted">Minimum nominal withdrawal yang dapat diambil adalah Rp. <?php echo e(number_format(minWithdrawal(),0,'.','.')); ?>.</small>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                <div class="form-group col-12">
                                    <label>Rekening <span class="text-danger">*</span></label>
                                    <select class="form-control <?php echo e($errors->has('rekening') ? 'border-danger' : ''); ?>" name="rekening" <?php echo e(Auth::user()->saldo < minWithdrawal() || $current_withdrawal ? 'disabled' : ''); ?>>
                    ...
                    <div class="border-top">
                        <button id="btn-submit" type="submit" class="btn btn-success" title="<?php echo e($current_withdrawal ? 'Belum bisa mengambil komisi karena masih memproses pengambilan komisi yang sebelumnya' : ''); ?>" <?php echo e(Auth::user()->saldo < minWithdrawal() || $current_withdrawal ? 'disabled' : ''); ?>>Kirim Komisi Saya</button>
                    </div>
                </div>
                <!-- card -->
            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('template/member/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/campusdigital.id/laravel-campusdigital/resources/views/komisi/member/index.blade.php ENDPATH**/ ?>