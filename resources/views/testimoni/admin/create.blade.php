                        ...
                        <form id="form" method="post" action="/admin/konten-web/testimoni/store" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="nama_klien" class="form-control {{ $errors->has('nama_klien') ? 'is-invalid' : '' }}" value="{{ old('nama_klien') }}" placeholder="Masukkan Nama Klien">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="profesi_klien" class="form-control {{ $errors->has('profesi_klien') ? 'is-invalid' : '' }}" value="{{ old('profesi_klien') }}" placeholder="Masukkan Profesi Klien">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="testimoni" class="form-control {{ $errors->has('testimoni') ? 'is-invalid' : '' }}" rows="5" placeholder="Masukkan Testimoni">{{ old('testimoni') }}</textarea>
