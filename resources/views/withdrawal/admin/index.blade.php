                            ...
                            <table id="table-history-withdrawal" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span title="{{ date('Y-m-d H:i:s', strtotime($data->withdrawal_at)) }}" style="text-decoration: underline; cursor: help;">{{ date('Y-m-d', strtotime($data->withdrawal_at)) }}</span></td>
