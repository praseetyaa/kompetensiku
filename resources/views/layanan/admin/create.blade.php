                        ...
                        <form id="form" method="post" action="/admin/konten-web/layanan/store" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="layanan" class="form-control {{ $errors->has('layanan') ? 'is-invalid' : '' }}" value="{{ old('layanan') }}" placeholder="Masukkan Layanan">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="caption" class="form-control {{ $errors->has('caption') ? 'is-invalid' : '' }}" rows="5" placeholder="Masukkan Caption">{{ old('caption') }}</textarea>
