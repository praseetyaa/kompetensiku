                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/script/update" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="hidden" name="id" value="{{ $script->id_script }}">
                            <input type="hidden" name="id_rak" value="{{ $rak->id_rak }}">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Judul Script <span class="text-danger">*</span></label>
                                    <input type="text" name="judul" class="form-control {{ $errors->has('judul') ? 'is-invalid' : '' }}" value="{{ $script->script_title }}" placeholder="Masukkan Judul Script">
                                    @if($errors->has('judul'))
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="script" class="form-control {{ $errors->has('script') ? 'is-invalid' : '' }}" placeholder="Masukkan Script" rows="10">{!! html_entity_decode($script->script) !!}</textarea>
