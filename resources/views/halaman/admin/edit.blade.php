                        ...
                        <form id="form" method="post" action="/admin/halaman/update" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="judul_halaman" class="form-control {{ $errors->has('judul_halaman') ? 'is-invalid' : '' }}" value="{{ $halaman->halaman_title }}" placeholder="Masukkan Judul Halaman">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <div id="editor">{!! html_entity_decode($halaman->konten) !!}</div> 
