        ...
        <div class="row">
            ...
            <div class="col-lg-6 mx-auto">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/pengaturan/platform/update" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <input type="hidden" name="id" value="{{ $platform->id_platform }}">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    <label>Nama Platform <span class="text-danger">*</span></label>
                                    <input type="text" name="nama_platform" class="form-control {{ $errors->has('nama_platform') ? 'is-invalid' : '' }}" value="{{ $platform->nama_platform }}" placeholder="Masukkan Nama Platform">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <select name="tipe_platform" class="form-control {{ $errors->has('tipe_platform') ? 'is-invalid' : '' }}">
										...
										<option value="1" {{ $platform->tipe_platform == 1 ? 'selected' : '' }}>Bank</option>
										<option value="2" {{ $platform->tipe_platform == 2 ? 'selected' : '' }}>Fintech</option>
									</select>
