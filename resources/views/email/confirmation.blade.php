										...
										<table class="subcopy" width="100%" cellpadding="0" cellspacing="0" role="presentation">
											...
											<tr>
												<td id="td-content">
													<strong>Hai,</strong>
													<br>
													Sekedar memberitahukan bahwa <strong>{{ $user->nama_user }}</strong> telah mendaftar di {{ get_website_name() }} dan melakukan pembayaran dengan invoice <strong>{{ $komisi->inv_komisi }}</strong>.
													<br>
