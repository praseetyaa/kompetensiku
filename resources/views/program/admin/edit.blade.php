                        ...
                        <form id="form" method="post" action="/admin/program/update" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="judul_program" class="form-control {{ $errors->has('judul_program') ? 'is-invalid' : '' }}" value="{{ $program->program_title }}" placeholder="Masukkan Judul Program">
                                ...
                                <div class="form-group col-md-12">
									...
									<br>
									<img id="img-file" src="{{ $program->program_gambar != '' ? asset('assets/images/cover-program/'.$program->program_gambar) : '' }}" class="mt-2 img-thumbnail {{ $program->program_gambar != '' ? '' : 'd-none' }}" style="max-height: 150px">
