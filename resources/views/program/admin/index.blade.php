                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
										<td><a href="/program/{{ $data->program_permalink }}" target="_blank">{{ $data->program_title }}</a></td>
                                        <td>{{ $data->program_kategori }}</td>
                                        <td>{{ $data->nama_user }}</td>
                                        <td><span title="{{ date('Y-m-d H:i:s', strtotime($data->program_at)) }}" style="text-decoration: underline; cursor: help;">{{ date('Y-m-d', strtotime($data->program_at)) }}</span></td>
                                        <td><a href="/admin/program/edit/{{ $data->id_program }}" class="btn btn-warning btn-sm btn-block" title="Edit"><i class="fa fa-edit"></i></a></td>
                                        <td><a href="#" class="btn btn-danger btn-sm btn-block btn-delete" data-id="{{ $data->id_program }}" title="Hapus"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    @php $i++; @endphp
                                    @endforeach
                                </tbody>
