                            ...
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
											{{ generate_date_range('join', $data->pelatihan->tanggal_pelatihan_from.' - '.$data->pelatihan->tanggal_pelatihan_to)['from'] }}
											<br>
											s.d.
											<br>
											{{ generate_date_range('join', $data->pelatihan->tanggal_pelatihan_from.' - '.$data->pelatihan->tanggal_pelatihan_to)['to'] }}
										</td>
										<td>
											...
											<div class="dropdown-menu dropdown-menu-right shadow">
											  <a class="dropdown-item" href="/member/e-sertifikat/peserta/detail/{{ $data->id_pm }}?page=1" target="_blank">Halaman Depan</a>
											  <a class="dropdown-item" href="/member/e-sertifikat/peserta/detail/{{ $data->id_pm }}?page=2" target="_blank">Halaman Belakang</a>
											</div>
										</td>
                                    </tr>
                                    @php $i++; @endphp
