                                    ...
                                    <tr>
										...
										<td>
											...
											<div class="dropdown-menu dropdown-menu-right shadow">
											  <a class="dropdown-item" href="/admin/e-sertifikat/peserta/detail/{{ $data->id_pm }}?page=1" target="_blank">Halaman Depan</a>
											  <a class="dropdown-item" href="/admin/e-sertifikat/peserta/detail/{{ $data->id_pm }}?page=2" target="_blank">Halaman Belakang</a>
											</div>
										</td>
                                    </tr>
                                    @php $i++; @endphp
