...
<head>
	...
	<style type="text/css">
		...
		@font-face {font-family: 'Old-English'; src: url({{ asset('assets/fonts/OLDENGL.ttf') }});}
		
		@page {margin: 0px;}
		html {margin: 0px;}
		/* body {margin: 0px; font-family: 'Lato-Regular'; font-size: 18.5px; background-color: {{ get_warna_background_sertifikat() }};} */
		body {margin: 0px; font-family: 'Lato-Regular'; font-size: 18.5px; background-image: url('{{ asset('assets/images/others/SERTIFIKAT BM.jpg') }}'); background-size: cover;}
