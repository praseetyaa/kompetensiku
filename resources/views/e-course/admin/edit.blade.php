                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/e-course/update" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="chapter" value="{{ $course->id_cc }}">
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select name="course_nomor" class="form-control {{ $errors->has('course_nomor') ? 'is-invalid' : '' }}">
                                        ...
                                        @for($i=1; $i<=100; $i++)
										<option value="{{ $i }}" {{ $course->course_nomor == $i ? 'selected' : '' }} {{ in_array($i, $array) ? 'disabled' : '' }}>#{{ $i }}</option>
                                        @endfor
									</select>
                                ...
                                <div class="form-group col-md-8">
                                    ...
                                    <input type="text" name="judul" class="form-control {{ $errors->has('judul') ? 'is-invalid' : '' }}" value="{{ $course->course_judul }}" placeholder="Masukkan Judul">
                                    @if($errors->has('judul'))
                                ...
                                <div class="form-group col-md-12">
									...
									<img id="img-file" src="{{ $course->course_gambar != '' ? asset('assets/images/course/'.$course->course_gambar) : '' }}" class="mt-2 img-thumbnail {{ $course->course_gambar != '' ? '' : 'd-none' }}" style="max-height: 150px">
									<input type="hidden" name="thumbnail" id="src-img">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>Caption <span class="text-danger">*</span></label>
                                    <textarea name="caption" class="form-control {{ $errors->has('caption') ? 'is-invalid' : '' }}" rows="3" placeholder="Masukkan Caption">{{ $course->course_caption }}</textarea>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="kode_youtube" class="form-control {{ $errors->has('kode_youtube') ? 'is-invalid' : '' }}" value="{{ $course->course_youtube }}" placeholder="Masukkan Kode YouTube">
