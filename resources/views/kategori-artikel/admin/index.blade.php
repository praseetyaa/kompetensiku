                            ...
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
										...
										<td>{{ $data->kategori }}</td>
										<td>{{ $data->slug }}</td>
                                        <td><a href="/admin/artikel/kategori/edit/{{ $data->id_ka }}" class="btn btn-warning btn-sm btn-block" title="Edit"><i class="fa fa-edit"></i></a></td>
                                        <td><a href="#" class="btn btn-danger btn-sm btn-block btn-delete" data-id="{{ $data->id_ka }}" title="Hapus"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    @php $i++; @endphp
                                    @endforeach
                                </tbody>
