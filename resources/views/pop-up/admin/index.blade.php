                            ...
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
										...
										<td><a href="{{ asset('assets/images/pop-up/'.$data->popup_gambar) }}" class="image-popup-vertical-fit"><img src="{{ asset('assets/images/pop-up/'.$data->popup_gambar) }}" class="img-thumbnail" style="max-width: 200px;"></a></td>
										<td>{{ $data->popup_from }}<br>sampai<br>{{ $data->popup_to }}</td>
