        ...
        <div class="info-text">
          ...
          <div class="">
            <div class="col-12 p-1 text-light small" style="background-color: #fb8312;">
              <div class="row">
                <div class="col-md">
                  <span title="{{ date('Y-m-d H:i:s', strtotime($karir->karir_at)) }}"><i class="fa fa-clock-o mr-2"></i> {{ generate_date($karir->karir_at) }}</span>
                </div>
                <div class="col-md">
		  ...
		  <div class="text-center mt-3">
		  	<img class="img-fluid" src="{{ $karir->karir_gambar != '' ? asset('assets/images/cover-karir/'.$karir->karir_gambar) : asset('assets/images/others/default.jpg') }}">
	      </div>
