				...
				<div class="col-lg-3 col-md-6 mb-3">
					<div class="card">
						<a href="/karir/{{ $karir->karir_permalink }}">
							<img class="card-img-top" src="{{ $karir->karir_gambar != '' ? asset('assets/images/cover-karir/'.$karir->karir_gambar) : asset('assets/images/others/default.jpg') }}" alt="Sampul Karir">
						</a>
						<div class="card-body">
