    ...
    <div class="row h-100">
      <div class="col-lg-12 my-auto">
        <div class="hs-text">
			...
			<p data-aos="fade-down" data-aos-duration="2500"><a href="/register{{ Session::get('ref') != null ? '?ref='.Session::get('ref') : '' }}" class="btn-register-2">Daftar</a></p>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-5 text-center mb-4">
        <img src="{{ asset('assets/images/others/undraw_marketing_v0iu.svg') }}" style="max-width: 80%;" alt="" data-aos="fade-down" data-aos-duration="3000">
      </div>
      <div class="col-lg-7">
...
<section class="cta-section set-bg" data-setbg="{{ asset('templates/loans2go/img/cta-bg.jpg') }}">
  <div class="container">
    ...
    <a data-aos="fade-down" data-aos-duration="1500" href="/beasiswa{{ Session::get('ref') != null ? '?ref='.Session::get('ref') : '' }}" class="site-btn sb-big">Lihat Selengkapnya</a>
  </div>
</section>
<!-- CTA Section end -->
    ...
    <div class="feature-item">
      <div class="row">
        <div class="col-lg-6 text-center mb-4">
          <img src="{{ asset('assets/images/others/meeting.png') }}" style="max-width: 80%;" alt="" data-aos="fade-down" data-aos-duration="1500">
        </div>
        <div class="col-lg-6">
          <div class="feature-text">
            ...
            <a data-aos="fade-down" data-aos-duration="2000" href="/beasiswa{{ Session::get('ref') != null ? '?ref='.Session::get('ref') : '' }}" class="btn-link-secondary">Detail dan Persyaratan <img src="{{ asset('templates/loans2go/img/arrow.png') }}" alt=""></a>
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="owl-carousel owl-theme" id="mitra">
			  @foreach($mitra as $data)
				<div class="text-center" data-aos="fade-down" data-aos-duration="1500" style="height: 150px">
				  <p>{{ $data->nama_mitra }}</p>
				  <img src="{{ asset('assets/images/mitra/'.$data->logo_mitra) }}" class="mb-3 mx-auto" style="max-height: 100px; width: auto!important;">
				</div>
			  @endforeach
          </div>
        </div>
