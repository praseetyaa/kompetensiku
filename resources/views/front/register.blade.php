				...
				<form id="registration-form" method="post" action="/register">
					<div class="card-body">
						  ...
						  <div class="col-12 mb-3 text-center">
							<a href="#" target="_blank" class="btn btn-theme-1"><i class="fa fa-download mr-2"></i> Download Tutorial Pendaftaran Member Kompetensiku</a>
						  </div>
						  <div class="alert alert-success text-center">
							<strong>Biaya Aktivasi:</strong><br><del class="h5 text-danger">Rp. 999.000</del><br><span class="h4">Rp. {{ number_format(get_biaya_aktivasi(),0,'.','.') }}</span>
						  </div>
