                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right mailbox animated bounceInDown shadow" aria-labelledby="2">
                                <ul class="list-style-none">
                                    ...
                                    <li>
                                        <a href="/member/materi/{{ generate_permalink($file['kategori']) }}" class="link border-top">
                                            <div class="d-flex no-block align-items-center p-10">
                                                <span class="btn btn-success btn-circle"><i class="ti-book"></i></span>
                                                <div class="m-l-10">
                                                    <h5 class="m-b-0">{{ $file['kategori'] }}</h5> 
                                                    <span class="mail-desc">{{ $file['total'] }} postingan baru.</span> 
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                        ...
                                        <a href="/member/e-course" class="link border-top">
                                            <div class="d-flex no-block align-items-center p-10">
                                                ...
                                                <div class="m-l-10">
                                                    ...
                                                    <span class="mail-desc">{{ $global_e_course_total }} postingan baru.</span> 
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                        ...
                                        <a href="/artikel" class="link border-top" target="_blank">
                                            <div class="d-flex no-block align-items-center p-10">
                                                ...
                                                <div class="m-l-10">
                                                    ...
                                                    <span class="mail-desc">{{ $global_artikel_total }} postingan baru.</span> 
                                                </div>
                                            </div>
                                        </a>
                                    </li>
