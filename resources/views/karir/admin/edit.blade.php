                        ...
                        <form id="form" method="post" action="/admin/karir/update" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="judul_karir" class="form-control {{ $errors->has('judul_karir') ? 'is-invalid' : '' }}" value="{{ $karir->karir_title }}" placeholder="Masukkan Judul Karir">
                                    @if($errors->has('judul_karir'))
                                    <small class="text-danger">{{ ucfirst($errors->first('judul_karir')) }}</small>
                                    @endif
                                </div>
                                <div class="form-group col-md-12">
                                    <label>Gambar</label>
									...
									<br>
									<img id="img-file" src="{{ $karir->karir_gambar != '' ? asset('assets/images/cover-karir/'.$karir->karir_gambar) : '' }}" class="mt-2 img-thumbnail {{ $karir->karir_gambar != '' ? '' : 'd-none' }}" style="max-height: 150px">
									<input type="hidden" name="gambar" id="src-img">
                                </div>
                                <div class="form-group col-md-12">
                                    <label>URL <span class="text-danger">*</span></label>
                                    <input type="text" name="url" class="form-control {{ $errors->has('url') ? 'is-invalid' : '' }}" value="{{ $karir->karir_url }}" placeholder="Masukkan URL">
                                    @if($errors->has('url'))
