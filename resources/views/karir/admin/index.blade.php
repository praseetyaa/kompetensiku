                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
										<td><a href="/karir/{{ $data->karir_permalink }}" target="_blank">{{ $data->karir_title }}</a></td>
                                        <td>{{ $data->nama_user }}</td>
                                        <td><span title="{{ date('Y-m-d H:i:s', strtotime($data->karir_at)) }}" style="text-decoration: underline; cursor: help;">{{ date('Y-m-d', strtotime($data->karir_at)) }}</span></td>
                                        <td><a href="/admin/karir/edit/{{ $data->id_karir }}" class="btn btn-warning btn-sm btn-block" title="Edit"><i class="fa fa-edit"></i></a></td>
                                        <td><a href="#" class="btn btn-danger btn-sm btn-block btn-delete" data-id="{{ $data->id_karir }}" title="Hapus"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    @php $i++; @endphp
                                    @endforeach
                                </tbody>
