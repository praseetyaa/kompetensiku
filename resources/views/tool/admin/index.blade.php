							...
							<table id="table-produk" class="table table-hover table-bordered">
								...
								<tbody>
									...
									<tr class="data-toolbox" data-id="{{ $toolbox->id_toolbox }}">
                                        ...
                                        <td>
											<span title="{{ date('Y-m-d H:i:s', strtotime($toolbox->modified_at)) }}" style="text-decoration: underline; cursor: help;">
												{{ date('Y-m-d', strtotime($toolbox->modified_at)) }}
											</span>
										</td>
                                        @if(Auth::user()->role == role_it() || Auth::user()->role == role_manajer() || Auth::user()->role == role_mentor())
										<td>
									...
									<tr class="data-file" data-id="{{ $tool->id_tool }}">
                                        ...
                                        <td>
											<span title="{{ date('Y-m-d H:i:s', strtotime($tool->uploaded_at)) }}" style="text-decoration: underline; cursor: help;">
												{{ date('Y-m-d', strtotime($tool->uploaded_at)) }}
											</span>
										</td>
                                        @if(Auth::user()->role == role_it() || Auth::user()->role == role_manajer() || Auth::user()->role == role_mentor())
										<td>
