                        ...
                        <div class="table-responsive">
                            <table id="table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $i }}</td>
										<td><a href="{{ asset('assets/images/slider/'.$data->slider) }}" class="image-popup-vertical-fit"><img src="{{ asset('assets/images/slider/'.$data->slider) }}" class="img-thumbnail" style="max-height: 150px;"></a></td>
                                        <td>{{ $data->slider_url != '' ? $data->slider_url : '-' }}</td>
                                        <td>{{ $data->status_slider == 1 ? 'Tampilkan' : 'Sembunyikan' }}</td>
                                        <td><a href="/admin/konten-web/slider/edit/{{ $data->id_slider }}" class="btn btn-warning btn-sm btn-block" title="Edit"><i class="fa fa-edit"></i></a></td>
                                        <td><a href="#" class="btn btn-danger btn-sm btn-block btn-delete" data-id="{{ $data->id_slider }}" title="Hapus"><i class="fa fa-trash"></i></a></td>
                                    </tr>
                                    @php $i++; @endphp
                                    @endforeach
                                </tbody>
