        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form id="form" method="post" action="/admin/pengaturan/rekening/store">
                            {{ csrf_field() }}
                            <div class="row">
								...
								<div class="form-group col-md-6">
									...
									<input type="text" name="nomor" class="form-control number-only {{ $errors->has('nomor') ? 'is-invalid' : '' }}" value="{{ old('nomor') }}" placeholder="Masukkan Nomor">
									@if($errors->has('nomor'))
								...
								<div class="form-group col-md-6">
									...
									<input type="text" name="atas_nama" class="form-control {{ $errors->has('atas_nama') ? 'is-invalid' : '' }}" value="{{ old('atas_nama') }}" placeholder="Masukkan Nama">
